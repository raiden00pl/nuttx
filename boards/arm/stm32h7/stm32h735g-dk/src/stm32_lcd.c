/****************************************************************************
 * boards/arm/stm32h7/stm32h735g-dk/src/stm32_lcd.c
 *
...
#if CONFIG_STM32_LTDC_FB_BASE < 0x70000000 || \
    CONFIG_STM32_LTDC_FB_BASE + CONFIG_STM32_LTDC_FB_SIZE > 0x71000000
#  error "The LCD framebuffer must reside in HyperRAM"
#endif
...
int up_fbinitialize(int display)
{
  ...
  stm32_configgpio(GPIO_LCD_DISP_EN);
