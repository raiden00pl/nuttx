/****************************************************************************
 * boards/arm/nrf52/thingy52/src/nrf52_adc.c
 *
...
static struct nrf52_adc_channel_s g_adc_chanlist[ADC_NCHANNELS] =
{
  ...
  {
    .p_psel  = NRF52_ADC_IN_IN4,         /* AIN4 / P0.28 - BATTERY */
    .n_psel  = 0,
 ...
 *
 * Description:
 *   Initialize ADC and register the ADC device.  The battery voltage
 *   divider is gated by the SX1509 BAT_MON_EN pin, which is enabled during
 *   the SX1509 bring-up.
 *
 ****************************************************************************/
