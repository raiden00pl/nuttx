...
/* USART2 (Nucleo Virtual Console): Default board solder bridge configuration
 * has USART2 going to the on board ST-Link to provide a VCP. Refer to
 * STMicro user manual [UM3121] for more info on solder bridge configuration.
 */
