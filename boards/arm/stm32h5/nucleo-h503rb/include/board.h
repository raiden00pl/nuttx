 ...
 * has USART3 going to the on board ST-Link to provide a VCP (PA2 is not
 * routed on this board). Refer to STMicro user manual [UM3121] for more
 * info on solder bridge configuration.
 */
