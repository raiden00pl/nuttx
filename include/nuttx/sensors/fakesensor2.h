...
#ifndef __INCLUDE_NUTTX_SENSORS_FAKESENSOR2_H
#define __INCLUDE_NUTTX_SENSORS_FAKESENSOR2_H
...
{
  int              interval;    /* Interval in millisecond */
...
int fakesensor2_init(int type, FAR const struct fakesensor2_data_s *data,
...
#endif  /* __INCLUDE_NUTTX_SENSORS_FAKESENSOR2_H */
