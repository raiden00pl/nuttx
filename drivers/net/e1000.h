...
#define E1000_RDBAL   (0x2800)      /* Tx Descriptor Base Address Low */
...
#  define E1000_CTRL_SPEED_10MBS   (0b00 << E1000_CTRL_SPEED_SHIFT)
#  define E1000_CTRL_SPEED_100MBS  (0b01 << E1000_CTRL_SPEED_SHIFT)
#  define E1000_CTRL_SPEED_1000MBS (0b10 << E1000_CTRL_SPEED_SHIFT)
                                              /* Bit 10: Reserved */
#define E1000_CTRL_FRCSPD          (1 << 11)  /* Bit 11: Force Speed */
#define E1000_CTRL_FRCDPLX         (1 << 12)  /* Bit 12: Force Duplex */
                                              /* Bits 13-17: Reserved */
#define E1000_CTRL_SDP0DATA        (1 << 18)  /* Bit 18: SDP0 Data Value */
...
#define E1000_RCTL_PMCF            (1 << 23)  /* Bit 23: Pass MAC Control Frames */
                                              /* Bit 24: Reserved */
#define E1000_RCTL_BSEX            (1 << 24)  /* Bit 24: Buffer Size Extension */
#define E1000_RCTL_SECRC           (1 << 25)  /* Bit 25: Strip Ethernet CRC from incoming packet */
                                              /* Bits 27-31: Reserved */
...
#define TDESC_CMD_EOP              (1 << 0)   /* Bit 0: End Of Packet */
#define TDESC_CMD_IFCS             (1 << 1)   /* Bit 1: Insert FCS */
#define TDESC_CMD_IC               (1 << 2)   /* Bit 2: Insert Checksum */
#define TDESC_CMD_RS               (1 << 3)   /* Bit 3: Report Status */
#define TDESC_CMD_RPS              (1 << 4)   /* Bit 4: Report Packet Sent */
#define TDESC_CMD_DEXT             (1 << 5)   /* Bit 5: Extension (0b for legacy mode) */
#define TDESC_CMD_VLE              (1 << 6)   /* Bit 6: VLAN Packet Enable */
#define TDESC_CMD_IDE              (1 << 7)   /* Bit 7: Interrupt Delay Enable */

/* Transmit Descriptor Status Field */

#define TDESC_STATUS_DD            (1 << 0)   /* Bit 0: Descriptor Done */
#define TDESC_STATUS_EC            (1 << 1)   /* Bit 1: Excess Collisions */
#define TDESC_STATUS_LC            (1 << 2)   /* Bit 2: Late Collision */
#define TDESC_STATUS_RSU           (1 << 3)   /* Bit 3: Transmit Underrun */

/* Transmit Descriptor Special Field */

#define TDESC_SPECIAL_VLAN_SHIFT   (0)        /* Bits 0-11: VLAN Identifier */
#define TDESC_SPECIAL_CFI          (1 << 12)  /* Bit 12: Canonical Form Indicator */
#define TDESC_SPECIAL_PRI_SHIFT    (13)       /* Bits 13-15: User Priority */

/* Receive Descriptor Status Field */

#define RDESC_STATUS_DD            (1 << 0)   /* Bit 0: Descriptor Done */
#define RDESC_STATUS_EOP           (1 << 1)   /* Bit 1: End of Packet */
#define RDESC_STATUS_IXSM          (1 << 2)   /* Bit 2: Ignore Checksum Indication */
#define RDESC_STATUS_VP            (1 << 3)   /* Bit 3: Packet is 802.1Q (matched VET) */
#define RDESC_STATUS_RSV           (1 << 4)   /* Bit 4: Reserved */
#define RDESC_STATUS_TCPCS         (1 << 5)   /* Bit 5: TCP Checksum Calculated on Packet */
#define RDESC_STATUS_IPCS          (1 << 6)   /* Bit 6: IP Checksum Calculated on Packet */
#define RDESC_STATUS_PIF           (1 << 7)   /* Bit 7: Passed in-exact filter */

/* Receive Descriptor Errors Field */

#define RDESC_ERRORS_CE            (1 << 0)   /* Bit 0: CRC Error or Alignment Error */
#define RDESC_ERRORS_SE            (1 << 1)   /* Bit 1: Symbol Error */
#define RDESC_ERRORS_SEQ           (1 << 2)   /* Bit 2: Sequence Error */
#define RDESC_ERRORS_RSV           (1 << 3)   /* Bit 3: Reserved */
#define RDESC_ERRORS_CXE           (1 << 4)   /* Bit 4: Carrier Extension Error */
#define RDESC_ERRORS_TCPE          (1 << 5)   /* Bit 5: TCP/UDP Checksum Error */
#define RDESC_ERRORS_IPE           (1 << 6)   /* Bit 6: IP Checksum Error */
#define RDESC_ERRORS_RXE           (1 << 7)   /* Bit 7: RX Data Error */

/* Receive Descriptor Special Field */

#define RDESC_SPECIAL_VLAN_SHIFT   (0)        /* Bits 0-11: VLAN Identifier */
#define RDESC_SPECIAL_CFI          (1 << 12)  /* Bit 12: Canonical Form Indicator */
#define RDESC_SPECIAL_PRI_SHIFT    (13)       /* Bits 13-15: User Priority */
