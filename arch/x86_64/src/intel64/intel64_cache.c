...
static inline void x86_wbindv(void)
{
...
static inline void x86_wbnoinvd(void)
{
  asm volatile("wbnoinvd" : : : "memory");
}

/****************************************************************************
 * Name: x86_cache_linesize
 ****************************************************************************/

static size_t x86_cache_linesize(void)
{
...
static size_t x86_cache_size(int leaf)
{
  unsigned long eax;
  unsigned long ebx;
  unsigned long ecx;
...
/****************************************************************************
 * Name: x86_cache_enable
 ****************************************************************************/

static void x86_cache_enable(void)
{
...
/****************************************************************************
 * Name: x86_cache_disable
 ****************************************************************************/

static void x86_cache_disable(void)
{
