...
begin_packed_struct struct acpi_rsdp_s
{
  ...
  uint8_t  _reserved[3];     /* Reserved field */
} end_packed_struct;
...
int acpi_madt_get(int type, int n, FAR struct acpi_entry_s **entry);
...
int acpi_lapic_get(int cpu, FAR struct acpi_lapic_s **lapic);
