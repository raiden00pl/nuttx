/****************************************************************************
 * arch/arm/src/stm32u5/hardware/stm32_dmasigmap.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32U5_HARDWARE_STM32_DMASIGMAP_H
#define __ARCH_ARM_SRC_STM32U5_HARDWARE_STM32_DMASIGMAP_H

/****************************************************************************
 * Pre-processor Definitions
 ****************************************************************************/

/* GPDMA1 request signals.  The LPDMA1 instance uses a separate request
 * numbering and is not supported yet.
 */

#define GPDMA_REQ_ADC1          (0)
#define GPDMA_REQ_ADC4          (1)
...
#define GPDMA_REQ_SAI2_A        (38)
#define GPDMA_REQ_SAI2_B        (39)
#define GPDMA_REQ_OCTOSPI1      (40)
#define GPDMA_REQ_OCTOSPI2      (41)
...
#define GPDMA_REQ_TIM8_CH1      (49)
#define GPDMA_REQ_TIM8_CH2      (50)
#define GPDMA_REQ_TIM8_CH3      (51)
#define GPDMA_REQ_TIM8_CH4      (52)
#define GPDMA_REQ_TIM8_UP       (53)
#define GPDMA_REQ_TIM8_TRIG     (54)
#define GPDMA_REQ_TIM8_COM      (55)
...
#define GPDMA_REQ_TIM5_CH1      (72)
#define GPDMA_REQ_TIM5_CH2      (73)
#define GPDMA_REQ_TIM5_CH3      (74)
#define GPDMA_REQ_TIM5_CH4      (75)
#define GPDMA_REQ_TIM5_UP       (76)
#define GPDMA_REQ_TIM5_TRIG     (77)
...
#define GPDMA_REQ_DCMI_PSSI     (86)
#define GPDMA_REQ_AES_IN        (87)
#define GPDMA_REQ_AES_OUT       (88)
#define GPDMA_REQ_HASH_IN       (89)
#define GPDMA_REQ_UCPD1_TX      (90)
#define GPDMA_REQ_UCPD1_RX      (91)
#define GPDMA_REQ_MDF1_FLT0     (92)
#define GPDMA_REQ_MDF1_FLT1     (93)
#define GPDMA_REQ_MDF1_FLT2     (94)
#define GPDMA_REQ_MDF1_FLT3     (95)
#define GPDMA_REQ_MDF1_FLT4     (96)
#define GPDMA_REQ_MDF1_FLT5     (97)
#define GPDMA_REQ_ADF1_FLT0     (98)
#define GPDMA_REQ_FMAC_READ     (99)
#define GPDMA_REQ_FMAC_WRITE    (100)
#define GPDMA_REQ_CORDIC_READ   (101)
#define GPDMA_REQ_CORDIC_WRITE  (102)
...
#define GPDMA_REQ_HSPI1         (114)
#define GPDMA_REQ_I2C5_RX       (115)
#define GPDMA_REQ_I2C5_TX       (116)
#define GPDMA_REQ_I2C5_EVC      (117)
#define GPDMA_REQ_I2C6_RX       (118)
#define GPDMA_REQ_I2C6_TX       (119)
#define GPDMA_REQ_I2C6_EVC      (120)
#define GPDMA_REQ_USART6_RX     (121)
#define GPDMA_REQ_USART6_TX     (122)
#define GPDMA_REQ_ADC2          (123)
#define GPDMA_REQ_JPEG_RX       (124)
#define GPDMA_REQ_JPEG_TX       (125)
...
#endif /* __ARCH_ARM_SRC_STM32U5_HARDWARE_STM32_DMASIGMAP_H */
