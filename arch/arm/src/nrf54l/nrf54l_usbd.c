/****************************************************************************
 * arch/arm/src/nrf54l/nrf54l_usbd.c
 *
...
#include "hardware/nrf54l_usbd.h"
...
#if CONFIG_USBDEV_EP0_MAXSIZE != 8 && CONFIG_USBDEV_EP0_MAXSIZE != 16 && \
    CONFIG_USBDEV_EP0_MAXSIZE != 32 && CONFIG_USBDEV_EP0_MAXSIZE != 64
#  error Unsupported endpoint 0 packet size
#endif

#if defined(CONFIG_USBDEV_DUALSPEED) && CONFIG_USBDEV_EP0_MAXSIZE != 64
#  error High-speed endpoint 0 requires 64-byte packets
#endif
...
/* FIFO sizes are in 32-bit words. Reserve one high-speed bulk packet per
 * IN endpoint and a shared receive FIFO for all sixteen OUT endpoints.
 */

#define NRF54L_NENDPOINTS      16
#define NRF54L_RXFIFO_WORDS    768
#define NRF54L_EP0_TXFIFO_WORDS 16
#define NRF54L_TXFIFO_WORDS    128
...
#define NRF54L_TRACEERR_ALLOCFAIL            0x01
#define NRF54L_TRACEERR_BADCLEARFEATURE      0x02
#define NRF54L_TRACEERR_BADDEVGETSTATUS      0x03
#define NRF54L_TRACEERR_BADEPNO              0x04
#define NRF54L_TRACEERR_BADEPGETSTATUS       0x05
#define NRF54L_TRACEERR_BADGETCONFIG         0x06
#define NRF54L_TRACEERR_BADGETSETDESC        0x07
#define NRF54L_TRACEERR_BADGETSTATUS         0x08
#define NRF54L_TRACEERR_BADSETADDRESS        0x09
#define NRF54L_TRACEERR_BADSETCONFIG         0x0a
#define NRF54L_TRACEERR_BADSETFEATURE        0x0b
#define NRF54L_TRACEERR_BADTESTMODE          0x0c
#define NRF54L_TRACEERR_BINDFAILED           0x0d
#define NRF54L_TRACEERR_DISPATCHSTALL        0x0e
#define NRF54L_TRACEERR_DRIVER               0x0f
#define NRF54L_TRACEERR_DRIVERREGISTERED     0x10
#define NRF54L_TRACEERR_EP0NOSETUP           0x11
#define NRF54L_TRACEERR_EP0SETUPSTALLED      0x12
#define NRF54L_TRACEERR_EPINNULLPACKET       0x13
#define NRF54L_TRACEERR_EPINUNEXPECTED       0x14
#define NRF54L_TRACEERR_EPOUTNULLPACKET      0x15
#define NRF54L_TRACEERR_EPOUTUNEXPECTED      0x16
#define NRF54L_TRACEERR_INVALIDCTRLREQ       0x17
#define NRF54L_TRACEERR_INVALIDPARMS         0x18
#define NRF54L_TRACEERR_IRQREGISTRATION      0x19
#define NRF54L_TRACEERR_NOEP                 0x1a
#define NRF54L_TRACEERR_NOTCONFIGURED        0x1b
#define NRF54L_TRACEERR_EPOUTQEMPTY          0x1c
#define NRF54L_TRACEERR_EPINREQEMPTY         0x1d
#define NRF54L_TRACEERR_NOOUTSETUP           0x1e
#define NRF54L_TRACEERR_POLLTIMEOUT          0x1f

/* Trace interrupt codes */

#define NRF54L_TRACEINTID_USB                1       /* USB Interrupt entry/exit */
#define NRF54L_TRACEINTID_INTPENDING         2       /* On each pass through the loop */

#define NRF54L_TRACEINTID_EPOUT              (10 + 0) /* First level interrupt decode */
#define NRF54L_TRACEINTID_EPIN               (10 + 1)
#define NRF54L_TRACEINTID_MISMATCH           (10 + 2)
#define NRF54L_TRACEINTID_WAKEUP             (10 + 3)
#define NRF54L_TRACEINTID_SUSPEND            (10 + 4)
#define NRF54L_TRACEINTID_SOF                (10 + 5)
#define NRF54L_TRACEINTID_RXFIFO             (10 + 6)
#define NRF54L_TRACEINTID_DEVRESET           (10 + 7)
#define NRF54L_TRACEINTID_ENUMDNE            (10 + 8)
#define NRF54L_TRACEINTID_IISOIXFR           (10 + 9)
#define NRF54L_TRACEINTID_IISOOXFR           (10 + 10)
#define NRF54L_TRACEINTID_SRQ                (10 + 11)
#define NRF54L_TRACEINTID_OTG                (10 + 12)

#define NRF54L_TRACEINTID_EPOUT_XFRC         (40 + 0) /* EPOUT second level decode */
#define NRF54L_TRACEINTID_EPOUT_EPDISD       (40 + 1)
#define NRF54L_TRACEINTID_EPOUT_SETUP        (40 + 2)
#define NRF54L_TRACEINTID_DISPATCH           (40 + 3)

#define NRF54L_TRACEINTID_GETSTATUS          (50 + 0) /* EPOUT third level decode */
#define NRF54L_TRACEINTID_EPGETSTATUS        (50 + 1)
#define NRF54L_TRACEINTID_DEVGETSTATUS       (50 + 2)
#define NRF54L_TRACEINTID_IFGETSTATUS        (50 + 3)
#define NRF54L_TRACEINTID_CLEARFEATURE       (50 + 4)
#define NRF54L_TRACEINTID_SETFEATURE         (50 + 5)
#define NRF54L_TRACEINTID_SETADDRESS         (50 + 6)
#define NRF54L_TRACEINTID_GETSETDESC         (50 + 7)
#define NRF54L_TRACEINTID_GETCONFIG          (50 + 8)
#define NRF54L_TRACEINTID_SETCONFIG          (50 + 9)
#define NRF54L_TRACEINTID_GETSETIF           (50 + 10)
#define NRF54L_TRACEINTID_SYNCHFRAME         (50 + 11)

#define NRF54L_TRACEINTID_EPIN_XFRC          (70 + 0) /* EPIN second level decode */
#define NRF54L_TRACEINTID_EPIN_TOC           (70 + 1)
#define NRF54L_TRACEINTID_EPIN_ITTXFE        (70 + 2)
#define NRF54L_TRACEINTID_EPIN_EPDISD        (70 + 3)
#define NRF54L_TRACEINTID_EPIN_TXFE          (70 + 4)

#define NRF54L_TRACEINTID_EPIN_EMPWAIT       (80 + 0) /* EPIN second level decode */

#define NRF54L_TRACEINTID_OUTNAK             (90 + 0) /* RXFLVL second level decode */
#define NRF54L_TRACEINTID_OUTRECVD           (90 + 1)
#define NRF54L_TRACEINTID_OUTDONE            (90 + 2)
#define NRF54L_TRACEINTID_SETUPDONE          (90 + 3)
#define NRF54L_TRACEINTID_SETUPRECVD         (90 + 4)

/* Endpoints ****************************************************************/

/* Odd physical endpoint numbers are IN; even are OUT */

#define NRF54L_EPPHYIN2LOG(epphy)     ((uint8_t)(epphy)|USB_DIR_IN)
#define NRF54L_EPPHYOUT2LOG(epphy)    ((uint8_t)(epphy)|USB_DIR_OUT)
...
#define NRF54L_EP_AVAILABLE           (0xfffe)     /* All available endpoints */

/* Maximum packet sizes for full speed endpoints */

#define NRF54L_MAXPACKET              (64)         /* Max packet size (1-64) */

/* Delays *******************************************************************/

#define NRF54L_READY_DELAY            200000
#define NRF54L_FLUSH_DELAY            200000

/* Request queue operations *************************************************/

#define nrf54l_rqempty(ep)            ((ep)->head == NULL)
#define nrf54l_rqpeek(ep)             ((ep)->head)
...
enum nrf54l_ep0state_e
{
  ...
  EP0STATE_SETUP_OUT,      /* OUT SETUP packet received.  Waiting for the DATA
                            ...
                            *   SET:    Set in nrf54l_rxinterrupt() when SETUP OUT
                            *           packet is received.
                            *   TESTED: In nrf54l_ep0out_receive()
                            */
  EP0STATE_SETUP_READY,    /* IN SETUP packet received -OR- OUT SETUP packet and
                            ...
                            *   SET:    (1) nrf54l_ep0out_receive() when the OUT
                            *           SETUP data phase completes, or (2)
                            *           nrf54l_rxinterrupt() when an IN SETUP is
                            *           packet received.
                            *   TESTED: Tested in nrf54l_epout_interrupt() when
                            *           SETUP phase is done to see if the SETUP
                            *           command is ready to be processed.  Also
                            *           tested in nrf54l_ep0out_setup() just to
                            *           double-check that we have a SETUP request
                            *           and any accompanying data.
                            */
  EP0STATE_SETUP_PROCESS,  /* SETUP Packet is being processed by nrf54l_ep0out_setup():
  ...
  EP0STATE_SETUPRESPONSE,  /* Short SETUP response write (without a USB request):
                            ...
                            *           nrf54l_ep0in_setupresponse()
                            *   TESTED: Never
                            */
  EP0STATE_DATA_IN,        /* Waiting for data out stage (with a USB request):
                            *   SET:    In nrf54l_epin_request() when a write
                            *           request is processed on EP0.
                            *   TESTED: In nrf54l_epin() to see if we should
                            *           revert to SETUP processing.
                            */
  EP0STATE_DATA_OUT        /* Waiting for data in phase to complete ( with a
                            * USB request)
                            *   SET:    In nrf54l_epout_request() when a read
                            *           request is processed on EP0.
                            *   TESTED: In nrf54l_epout() to see if we should
                            *           revert to SETUP processing
                            */
};
...
struct nrf54l_req_s
{
  ...
  struct nrf54l_req_s  *flink;    /* Supports a singly linked list */
};
...
struct nrf54l_ep_s
{
   ...
   * to struct nrf54l_ep_s.
   */

  struct usbdev_ep_s      ep;          /* Standard endpoint structure */

  /* NRF54L-specific fields */

  struct nrf54l_usbdev_s *dev;          /* Reference to private driver data */
  struct nrf54l_req_s    *head;         /* Request list for this endpoint */
  struct nrf54l_req_s    *tail;
...
struct nrf54l_usbdev_s
{
  /* Common device fields.  This must be the first thing defined in the
   * structure so that it is possible to simply cast from struct usbdev_s
   * to struct nrf54l_usbdev_s.
   */
  ...
  struct work_s           vbuswork;
  bool                    initialized;
  bool                    active;
  bool                    connected;
  volatile bool           vbus_changed;
  ...
  uint8_t                 devstate:4;    /* See enum nrf54l_devstate_e */
  uint8_t                 ep0state:4;    /* See enum nrf54l_ep0state_e */
  uint8_t                 testmode:4;    /* Selected test mode */
  uint16_t                epavail[2];    /* Bitset of available OUT/IN endpoints */
  ...
  struct nrf54l_ep_s       epin[NRF54L_NENDPOINTS];
  struct nrf54l_ep_s       epout[NRF54L_NENDPOINTS];
};
...
#if defined(CONFIG_NRF54L_USBDEV_REGDEBUG) && defined(CONFIG_DEBUG_FEATURES)
static uint32_t    nrf54l_getreg(uint32_t addr);
static void        nrf54l_putreg(uint32_t val, uint32_t addr);
#else
#  define nrf54l_getreg(addr)     getreg32(addr)
#  define nrf54l_putreg(val,addr) putreg32(val,addr)
#endif

/* Request queue operations *************************************************/

static struct nrf54l_req_s *nrf54l_req_remfirst(struct nrf54l_ep_s *privep);
static bool       nrf54l_req_addlast(struct nrf54l_ep_s *privep,
                    struct nrf54l_req_s *req);

/* Low level data transfers and request operations **************************/

/* Special endpoint 0 data transfer logic */

static int         nrf54l_ep0_mpsiz(uint16_t maxpacket);
static void        nrf54l_ep0in_setupresponse(struct nrf54l_usbdev_s *priv,
                     uint8_t *data, uint32_t nbytes);
static inline void nrf54l_ep0in_transmitzlp(struct nrf54l_usbdev_s *priv);
static void        nrf54l_ep0in_activate(void);

static void        nrf54l_ep0out_ctrlsetup(struct nrf54l_usbdev_s *priv);

/* IN request and TxFIFO handling */

static void        nrf54l_txfifo_write(struct nrf54l_ep_s *privep,
                     uint8_t *buf, int nbytes);
static void        nrf54l_epin_transfer(struct nrf54l_ep_s *privep,
                     uint8_t *buf, int nbytes);
static void        nrf54l_epin_request(struct nrf54l_usbdev_s *priv,
                     struct nrf54l_ep_s *privep);

/* OUT request and RxFIFO handling */

static void        nrf54l_rxfifo_read(struct nrf54l_ep_s *privep,
                     uint8_t *dest, uint16_t len);
static void        nrf54l_rxfifo_discard(struct nrf54l_ep_s *privep,
                                        int len);
static void        nrf54l_epout_complete(struct nrf54l_usbdev_s *priv,
                     struct nrf54l_ep_s *privep);
static inline void nrf54l_ep0out_receive(struct nrf54l_ep_s *privep,
                                        int bcnt);
static inline void nrf54l_epout_receive(struct nrf54l_ep_s *privep,
                                       int bcnt);
static void        nrf54l_epout_request(struct nrf54l_usbdev_s *priv,
                     struct nrf54l_ep_s *privep);

/* General request handling */

static void        nrf54l_ep_flush(struct nrf54l_ep_s *privep);
static void        nrf54l_req_complete(struct nrf54l_ep_s *privep,
                     int16_t result);
static void        nrf54l_req_cancel(struct nrf54l_ep_s *privep,
                     int16_t status);

/* Interrupt handling *******************************************************/

static struct
nrf54l_ep_s *nrf54l_ep_findbyaddr(struct nrf54l_usbdev_s *priv,
                                uint16_t eplog);
static int         nrf54l_req_dispatch(struct nrf54l_usbdev_s *priv,
                     const struct usb_ctrlreq_s *ctrl);
static void        nrf54l_usbreset(struct nrf54l_usbdev_s *priv);

/* Second level OUT endpoint interrupt processing */

static inline void nrf54l_ep0out_testmode(struct nrf54l_usbdev_s *priv,
                     uint16_t index);
static inline void nrf54l_ep0out_stdrequest(struct nrf54l_usbdev_s *priv,
                     struct nrf54l_ctrlreq_s *ctrlreq);
static inline void nrf54l_ep0out_setup(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_epout(struct nrf54l_usbdev_s *priv,
                     uint8_t epno);
static inline void nrf54l_epout_interrupt(struct nrf54l_usbdev_s *priv);

/* Second level IN endpoint interrupt processing */

static inline void nrf54l_epin_runtestmode(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_epin(struct nrf54l_usbdev_s *priv, uint8_t epno);
static inline void nrf54l_epin_txfifoempty(struct nrf54l_usbdev_s *priv,
                     int epno);
static inline void nrf54l_epin_interrupt(struct nrf54l_usbdev_s *priv);

/* Other second level interrupt processing */

static inline void nrf54l_resumeinterrupt(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_suspendinterrupt(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_rxinterrupt(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_enuminterrupt(struct nrf54l_usbdev_s *priv);
#ifdef CONFIG_USBDEV_ISOCHRONOUS
static inline void nrf54l_isocininterrupt(struct nrf54l_usbdev_s *priv);
static inline void nrf54l_isocoutinterrupt(struct nrf54l_usbdev_s *priv);
#endif

/* First level interrupt processing */

static int         nrf54l_usbinterrupt(int irq, void *context,
                                      void *arg);
...
static void        nrf54l_enablegonak(struct nrf54l_ep_s *privep);
static void        nrf54l_disablegonak(struct nrf54l_ep_s *privep);

/* Endpoint configuration */

static int         nrf54l_epout_configure(struct nrf54l_ep_s *privep,
                     uint8_t eptype, uint16_t maxpacket);
static int         nrf54l_epin_configure(struct nrf54l_ep_s *privep,
                     uint8_t eptype, uint16_t maxpacket);
static int         nrf54l_ep_configure(struct usbdev_ep_s *ep,
                     const struct usb_epdesc_s *desc, bool last);
static void        nrf54l_ep0_configure(struct nrf54l_usbdev_s *priv);

/* Endpoint disable */

static void        nrf54l_epout_disable(struct nrf54l_ep_s *privep);
static void        nrf54l_epin_disable(struct nrf54l_ep_s *privep);
static int         nrf54l_ep_disable(struct usbdev_ep_s *ep);

/* Endpoint request management */

static struct usbdev_req_s *nrf54l_ep_allocreq(struct usbdev_ep_s *ep);
static void        nrf54l_ep_freereq(struct usbdev_ep_s *ep,
                     struct usbdev_req_s *);

/* Endpoint buffer management */

#ifdef CONFIG_USBDEV_DMA
static void       *nrf54l_ep_allocbuffer(struct usbdev_ep_s *ep,
                     unsigned bytes);
static void        nrf54l_ep_freebuffer(struct usbdev_ep_s *ep,
                     void *buf);
#endif

/* Endpoint request submission */

static int         nrf54l_ep_submit(struct usbdev_ep_s *ep,
                     struct usbdev_req_s *req);

/* Endpoint request cancellation */

static int         nrf54l_ep_cancel(struct usbdev_ep_s *ep,
                     struct usbdev_req_s *req);

/* Stall handling */

static int         nrf54l_epout_setstall(struct nrf54l_ep_s *privep);
static int         nrf54l_epin_setstall(struct nrf54l_ep_s *privep);
static int         nrf54l_ep_setstall(struct nrf54l_ep_s *privep);
static int         nrf54l_ep_clrstall(struct nrf54l_ep_s *privep);
static int         nrf54l_ep_stall(struct usbdev_ep_s *ep, bool resume);
static void        nrf54l_ep0_stall(struct nrf54l_usbdev_s *priv);

/* Endpoint allocation */

static struct usbdev_ep_s *nrf54l_ep_alloc(struct usbdev_s *dev,
                     uint8_t epno, bool in, uint8_t eptype);
static void        nrf54l_ep_free(struct usbdev_s *dev,
                     struct usbdev_ep_s *ep);

/* USB device controller operations *****************************************/

static int         nrf54l_getframe(struct usbdev_s *dev);
static int         nrf54l_wakeup(struct usbdev_s *dev);
static int         nrf54l_selfpowered(struct usbdev_s *dev,
                     bool selfpowered);
static int         nrf54l_pullup(struct usbdev_s *dev, bool enable);
static void        nrf54l_setaddress(struct nrf54l_usbdev_s *priv,
                     uint16_t address);
static int         nrf54l_txfifo_flush(uint32_t txfnum);
static int         nrf54l_rxfifo_flush(void);

/* Initialization ***********************************************************/

static void        nrf54l_swinitialize(struct nrf54l_usbdev_s *priv);
static int         nrf54l_hwinitialize(struct nrf54l_usbdev_s *priv);
static void        nrf54l_vbus_worker(void *arg);
static int         nrf54l_vbus_interrupt(int irq, void *context, void *arg);
...
static struct nrf54l_usbdev_s g_usbdev;
static mutex_t g_usbdev_lock = NXMUTEX_INITIALIZER;

static const struct usbdev_epops_s g_epops =
{
  .configure   = nrf54l_ep_configure,
  .disable     = nrf54l_ep_disable,
  .allocreq    = nrf54l_ep_allocreq,
  .freereq     = nrf54l_ep_freereq,
#ifdef CONFIG_USBDEV_DMA
  .allocbuffer = nrf54l_ep_allocbuffer,
  .freebuffer  = nrf54l_ep_freebuffer,
#endif
  .submit      = nrf54l_ep_submit,
  .cancel      = nrf54l_ep_cancel,
  .stall       = nrf54l_ep_stall,
};

static const struct usbdev_ops_s g_devops =
{
  .allocep     = nrf54l_ep_alloc,
  .freeep      = nrf54l_ep_free,
  .getframe    = nrf54l_getframe,
  .wakeup      = nrf54l_wakeup,
  .selfpowered = nrf54l_selfpowered,
  .pullup      = nrf54l_pullup,
};
...
{
  TRACE_STR(NRF54L_TRACEERR_ALLOCFAIL),
  TRACE_STR(NRF54L_TRACEERR_BADCLEARFEATURE),
  TRACE_STR(NRF54L_TRACEERR_BADDEVGETSTATUS),
  TRACE_STR(NRF54L_TRACEERR_BADEPNO),
  TRACE_STR(NRF54L_TRACEERR_BADEPGETSTATUS),
  TRACE_STR(NRF54L_TRACEERR_BADGETCONFIG),
  TRACE_STR(NRF54L_TRACEERR_BADGETSETDESC),
  TRACE_STR(NRF54L_TRACEERR_BADGETSTATUS),
  TRACE_STR(NRF54L_TRACEERR_BADSETADDRESS),
  TRACE_STR(NRF54L_TRACEERR_BADSETCONFIG),
  TRACE_STR(NRF54L_TRACEERR_BADSETFEATURE),
  TRACE_STR(NRF54L_TRACEERR_BADTESTMODE),
  TRACE_STR(NRF54L_TRACEERR_BINDFAILED),
  TRACE_STR(NRF54L_TRACEERR_DISPATCHSTALL),
  TRACE_STR(NRF54L_TRACEERR_DRIVER),
  TRACE_STR(NRF54L_TRACEERR_DRIVERREGISTERED),
  TRACE_STR(NRF54L_TRACEERR_EP0NOSETUP),
  TRACE_STR(NRF54L_TRACEERR_EP0SETUPSTALLED),
  TRACE_STR(NRF54L_TRACEERR_EPINNULLPACKET),
  TRACE_STR(NRF54L_TRACEERR_EPINUNEXPECTED),
  TRACE_STR(NRF54L_TRACEERR_EPOUTNULLPACKET),
  TRACE_STR(NRF54L_TRACEERR_EPOUTUNEXPECTED),
  TRACE_STR(NRF54L_TRACEERR_INVALIDCTRLREQ),
  TRACE_STR(NRF54L_TRACEERR_INVALIDPARMS),
  TRACE_STR(NRF54L_TRACEERR_IRQREGISTRATION),
  TRACE_STR(NRF54L_TRACEERR_NOEP),
  TRACE_STR(NRF54L_TRACEERR_NOTCONFIGURED),
  TRACE_STR(NRF54L_TRACEERR_EPOUTQEMPTY),
  TRACE_STR(NRF54L_TRACEERR_EPINREQEMPTY),
  TRACE_STR(NRF54L_TRACEERR_NOOUTSETUP),
  TRACE_STR(NRF54L_TRACEERR_POLLTIMEOUT),
  TRACE_STR_END
};
#endif
...
{
  TRACE_STR(NRF54L_TRACEINTID_USB),
  TRACE_STR(NRF54L_TRACEINTID_INTPENDING),
  TRACE_STR(NRF54L_TRACEINTID_EPOUT),
  TRACE_STR(NRF54L_TRACEINTID_EPIN),
  TRACE_STR(NRF54L_TRACEINTID_MISMATCH),
  TRACE_STR(NRF54L_TRACEINTID_WAKEUP),
  TRACE_STR(NRF54L_TRACEINTID_SUSPEND),
  TRACE_STR(NRF54L_TRACEINTID_SOF),
  TRACE_STR(NRF54L_TRACEINTID_RXFIFO),
  TRACE_STR(NRF54L_TRACEINTID_DEVRESET),
  TRACE_STR(NRF54L_TRACEINTID_ENUMDNE),
  TRACE_STR(NRF54L_TRACEINTID_IISOIXFR),
  TRACE_STR(NRF54L_TRACEINTID_IISOOXFR),
  TRACE_STR(NRF54L_TRACEINTID_SRQ),
  TRACE_STR(NRF54L_TRACEINTID_OTG),
  TRACE_STR(NRF54L_TRACEINTID_EPOUT_XFRC),
  TRACE_STR(NRF54L_TRACEINTID_EPOUT_EPDISD),
  TRACE_STR(NRF54L_TRACEINTID_EPOUT_SETUP),
  TRACE_STR(NRF54L_TRACEINTID_DISPATCH),
  TRACE_STR(NRF54L_TRACEINTID_GETSTATUS),
  TRACE_STR(NRF54L_TRACEINTID_EPGETSTATUS),
  TRACE_STR(NRF54L_TRACEINTID_DEVGETSTATUS),
  TRACE_STR(NRF54L_TRACEINTID_IFGETSTATUS),
  TRACE_STR(NRF54L_TRACEINTID_CLEARFEATURE),
  TRACE_STR(NRF54L_TRACEINTID_SETFEATURE),
  TRACE_STR(NRF54L_TRACEINTID_SETADDRESS),
  TRACE_STR(NRF54L_TRACEINTID_GETSETDESC),
  TRACE_STR(NRF54L_TRACEINTID_GETCONFIG),
  TRACE_STR(NRF54L_TRACEINTID_SETCONFIG),
  TRACE_STR(NRF54L_TRACEINTID_GETSETIF),
  TRACE_STR(NRF54L_TRACEINTID_SYNCHFRAME),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_XFRC),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_TOC),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_ITTXFE),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_EPDISD),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_TXFE),
  TRACE_STR(NRF54L_TRACEINTID_EPIN_EMPWAIT),
  TRACE_STR(NRF54L_TRACEINTID_OUTNAK),
  TRACE_STR(NRF54L_TRACEINTID_OUTRECVD),
  TRACE_STR(NRF54L_TRACEINTID_OUTDONE),
  TRACE_STR(NRF54L_TRACEINTID_SETUPDONE),
  TRACE_STR(NRF54L_TRACEINTID_SETUPRECVD),
  TRACE_STR_END
};
#endif
 ...
 *
 * Description:
 *   Check whether core registers can be accessed. Call with interrupts
 *   disabled to serialize against the VBUS worker and regulator interrupt.
 *
 ****************************************************************************/

static bool nrf54l_ready(struct nrf54l_usbdev_s *priv)
{
  return priv->active && !priv->vbus_changed && nrf54l_usbhs_vbus();
}
 ...
 *
 * Description:
 *   Get the contents of an NRF54L register
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Set the contents of an NRF54L register to a value
 *
 ****************************************************************************/
...
static struct nrf54l_req_s *nrf54l_req_remfirst(struct nrf54l_ep_s *privep)
{
  struct nrf54l_req_s *ret = privep->head;
...
/****************************************************************************
 * Name: nrf54l_ep0in_setupresponse
 *
 * Description:
...
{
  nrf54l_epin_transfer(&priv->epin[EP0], buf, nbytes);
  priv->ep0state = EP0STATE_SETUPRESPONSE;
  nrf54l_ep0out_ctrlsetup(priv);
}

/****************************************************************************
 * Name: nrf54l_ep0in_transmitzlp
 *
 * Description:
...
static inline void nrf54l_ep0in_transmitzlp(struct nrf54l_usbdev_s *priv)
{
  nrf54l_ep0in_setupresponse(priv, NULL, 0);
}

/****************************************************************************
 * Name: nrf54l_ep0_mpsiz
 *
 * Description:
 *   Encode the maximum packet size for either direction of endpoint 0.
 *
 ****************************************************************************/
...
static int nrf54l_ep0_mpsiz(uint16_t maxpacket)
{
  switch (maxpacket)
    {
      case 8:
        return OTG_DIEPCTL0_MPSIZ_8;

      case 16:
        return OTG_DIEPCTL0_MPSIZ_16;

      case 32:
        return OTG_DIEPCTL0_MPSIZ_32;

      case 64:
        return OTG_DIEPCTL0_MPSIZ_64;
...
static void nrf54l_ep0in_activate(void)
{
  ...
  /* Set the encoded maximum packet size of EP0 IN. */

  regval  = nrf54l_getreg(NRF54L_USBD_DIEPCTL(0));
  regval &= ~OTG_DIEPCTL0_MPSIZ_MASK;
  regval |= nrf54l_ep0_mpsiz(CONFIG_USBDEV_EP0_MAXSIZE);

  nrf54l_putreg(regval, NRF54L_USBD_DIEPCTL(0));

  /* Clear global IN NAK */

  regval  = nrf54l_getreg(NRF54L_USBD_DCTL);
  regval |= OTG_DCTL_CGINAK;
  nrf54l_putreg(regval, NRF54L_USBD_DCTL);
}

/****************************************************************************
 * Name: nrf54l_ep0out_ctrlsetup
 *
 * Description:
...
static void nrf54l_ep0out_ctrlsetup(struct nrf54l_usbdev_s *priv)
{
  ...
  nrf54l_putreg(regval, NRF54L_USBD_DOEPTSIZ(0));

  /* Then clear NAKing and enable the transfer */

  regval  = nrf54l_getreg(NRF54L_USBD_DOEPCTL(0));
  regval |= (OTG_DOEPCTL0_CNAK | OTG_DOEPCTL0_EPENA);
  nrf54l_putreg(regval, NRF54L_USBD_DOEPCTL(0));
}

/****************************************************************************
 * Name: nrf54l_txfifo_write
 *
 * Description:
                               ...
                               uint8_t *buf, int nbytes)
{
  ...
  regaddr = NRF54L_USBD_DFIFO_DEP(privep->epphy);
  ...
  for (i = 0; i < nbytes; i += 4)
    {
      ...
      for (j = 0; j < 4 && i + j < nbytes; j++)
        {
          regval |= (uint32_t)*buf++ << (8 * j);
        }

      /* Then write the packet data to the TxFIFO */

      nrf54l_putreg(regval, regaddr);
    }
}

/****************************************************************************
 * Name: nrf54l_epin_transfer
 *
 * Description:
                                ...
                                uint8_t *buf, int nbytes)
{
  ...
  regval = nrf54l_getreg(NRF54L_USBD_DIEPTSIZ(privep->epphy));
  ...
  nrf54l_putreg(regval, NRF54L_USBD_DIEPTSIZ(privep->epphy));

  /* Read the DIEPCTLx register */

  regval = nrf54l_getreg(NRF54L_USBD_DIEPCTL(privep->epphy));
  ...
  if (privep->eptype == USB_EP_ATTR_XFER_ISOC)
    {
      ...
      uint32_t status = nrf54l_getreg(NRF54L_USBD_DSTS);
  ...
  nrf54l_putreg(regval, NRF54L_USBD_DIEPCTL(privep->epphy));
  ...
  nrf54l_txfifo_write(privep, buf, nbytes);
}

/****************************************************************************
 * Name: nrf54l_epin_request
 *
 * Description:
                               ...
                               struct nrf54l_ep_s *privep)
{
   ...
   * events:
   *
   * 1. From nrf54l_epin during transfer complete interrupt processing.
   ...
   * 3. From nrf54l_epin_txfifoempty during TXFE interrupt processing.
   ...
   *
   * 4. From nrf54l_ep_submit when a new write request is received WHILE the
   *    endpoint is not active (privep->active == false).
   */

  /* Check the request from the head of the endpoint request queue */

  privreq = nrf54l_rqpeek(privep);
  if (!privreq)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EPINREQEMPTY), privep->epphy);
      ...
      regaddr = NRF54L_USBD_DIEPCTL(privep->epphy);
      regval  = nrf54l_getreg(regaddr);
  ...
  if (privreq->req.xfrd < privreq->req.len || privep->zlp)
#endif
    {
      ...
      regaddr = NRF54L_USBD_DTXFSTS(privep->epphy);
      ...
      if ((int)(regval & OTG_DTXFSTS_MASK) < nwords)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_EMPWAIT),
                  (uint16_t)regval);
          ...
          nrf54l_putreg(empmsk, NRF54L_USBD_DIEPEMPMSK);
          ...
          regval = nrf54l_getreg(NRF54L_USBD_DIEPTXF(privep->epphy));
      ...
      nrf54l_epin_transfer(privep, buf, nbytes);
  ...
  if (privreq->req.xfrd >= privreq->req.len && !privep->zlp)
    {
      ...
      nrf54l_req_complete(privep, OK);
    }
}

/****************************************************************************
 * Name: nrf54l_rxfifo_read
 *
 * Description:
                              ...
                              uint8_t *dest, uint16_t len)
{
  ...
  regaddr = NRF54L_USBD_DFIFO_DEP(EP0);
...
static void nrf54l_rxfifo_discard(struct nrf54l_ep_s *privep, int len)
{
  if (len > 0)
    {
      uint32_t regaddr;
      ...
      for (i = 0; i < len; i += 4)
        {
          volatile uint32_t data = nrf54l_getreg(regaddr);
                                 ...
                                 struct nrf54l_ep_s *privep)
{
  ...
  if (!privreq)
    {
      ...
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EPOUTQEMPTY),
               privep->epphy);
      privep->active = false;
      return;
    }
  ...
  nrf54l_epout_request(priv, privep);
}

/****************************************************************************
 * Name: nrf54l_ep0out_receive
 *
 * Description:
...
static inline void nrf54l_ep0out_receive(struct nrf54l_ep_s *privep,
                                        int bcnt)
{
  struct nrf54l_usbdev_s *priv;

  /* Sanity Checking */

  DEBUGASSERT(privep && privep->dev);
  priv = (struct nrf54l_usbdev_s *)privep->dev;
  ...
  if (priv->ep0state == EP0STATE_SETUP_OUT)
    {
      ...
      nrf54l_rxfifo_read(privep, priv->ep0data, readlen);

      /* Do we have to discard any excess bytes? */

      nrf54l_rxfifo_discard(privep, bcnt - ((readlen + 3) & ~3));
  ...
  else
    {
      ...
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_NOOUTSETUP), priv->ep0state);
      nrf54l_rxfifo_discard(privep, bcnt);
      privep->active = false;
    }
}

/****************************************************************************
 * Name: nrf54l_epout_receive
 *
 * Description:
 *   This function is called from the RXFLVL interrupt handler when new
 *   incoming data is available in the endpoint's RxFIFO.  This function
                                       ...
                                       int bcnt)
{
  ...
  if (!privreq)
    {
      ...
      if (privep->epphy == 0)
        {
          nrf54l_ep0out_receive(privep, bcnt);
        }
      else
        {
  ...
  nrf54l_rxfifo_read(privep, dest, readlen);
  ...
  if (!privep->active)
    {
      ...
      for (; ; )
        {
          ...
          if (!privreq)
            {
              ...
              regaddr = NRF54L_USBD_DOEPCTL(privep->epphy);
              regval  = nrf54l_getreg(regaddr);
          ...
          if (privreq->req.len <= 0)
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EPOUTNULLPACKET), 0);
              nrf54l_req_complete(privep, OK);
            }
      ...
      regaddr = NRF54L_USBD_DOEPTSIZ(privep->epphy);
      regval  = nrf54l_getreg(regaddr);
...
static void nrf54l_ep_flush(struct nrf54l_ep_s *privep)
{
  if (privep->isin)
    {
      nrf54l_txfifo_flush(OTG_GRSTCTL_TXFNUM_D(privep->epphy));
    }
  else
    {
      nrf54l_rxfifo_flush();
...
static void nrf54l_req_complete(struct nrf54l_ep_s *privep, int16_t result)
{
  struct nrf54l_req_s *privreq;

  /* Remove the request at the head of the request list */

  privreq = nrf54l_req_remfirst(privep);
...
static void nrf54l_req_cancel(struct nrf54l_ep_s *privep, int16_t status)
{
  if (!nrf54l_rqempty(privep) && nrf54l_ready(privep->dev))
    {
      nrf54l_ep_flush(privep);
    }

  while (!nrf54l_rqempty(privep))
    {
      usbtrace(TRACE_COMPLETE(privep->epphy),
               (nrf54l_rqpeek(privep))->req.xfrd);
      nrf54l_req_complete(privep, status);
    }
}

/****************************************************************************
 * Name: nrf54l_ep_findbyaddr
 *
 * Description:
...
static struct nrf54l_ep_s *nrf54l_ep_findbyaddr(struct nrf54l_usbdev_s *priv,
                                              uint16_t eplog)
{
  struct nrf54l_ep_s *privep;
  uint8_t epphy = USB_EPNO(eplog);

  if (epphy >= NRF54L_NENDPOINTS)
    {
      return NULL;
    }
                              ...
                              const struct usb_ctrlreq_s *ctrl)
{
  ...
  usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_DISPATCH), 0);
  if (priv->driver)
    {
  ...
  if (ret < 0)
    {
      ...
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_DISPATCHSTALL), 0);
      priv->stalled = true;
    }
...
static void nrf54l_usbreset(struct nrf54l_usbdev_s *priv)
{
  ...
  nrf54l_txfifo_flush(OTG_GRSTCTL_TXFNUM_D(EP0));
  ...
  priv->epavail[0] = NRF54L_EP_AVAILABLE;
  priv->epavail[1] = NRF54L_EP_AVAILABLE;

  /* Disable all end point interrupts */

  for (i = 0; i < NRF54L_NENDPOINTS ; i++)
    {
      /* Disable endpoint interrupts */

      nrf54l_putreg(0xff, NRF54L_USBD_DIEPINT(i));
      nrf54l_putreg(0xff, NRF54L_USBD_DOEPINT(i));

      /* Return write requests to the class implementation */

      privep = &priv->epin[i];
      nrf54l_req_cancel(privep, -ESHUTDOWN);
                                         ...
                                         uint16_t index)
{
  ...
  switch (testmode)
    {
      ...
      default:
        usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADTESTMODE), testmode);
        priv->dotest   = false;
  ...
  priv->dotest = true;
  nrf54l_ep0in_transmitzlp(priv);
}

/****************************************************************************
 * Name: nrf54l_ep0out_stdrequest
 *
 * Description:
...
static inline
void nrf54l_ep0out_stdrequest(struct nrf54l_usbdev_s *priv,
                             struct nrf54l_ctrlreq_s *ctrlreq)
{
  struct nrf54l_ep_s *privep;
  ...
  switch (ctrlreq->req)
    {
      case USB_REQ_GETSTATUS:
        {
          ...
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_GETSTATUS), 0);
          if (!priv->addressed ||
               ctrlreq->len != 2 ||
              ...
              switch (ctrlreq->type & USB_REQ_RECIPIENT_MASK)
                {
                  case USB_REQ_RECIPIENT_ENDPOINT:
                    {
                      usbtrace(TRACE_INTDECODE(
                               NRF54L_TRACEINTID_EPGETSTATUS), 0);
                      privep = nrf54l_ep_findbyaddr(priv, ctrlreq->index);
                      if (!privep)
                        {
                          usbtrace(TRACE_DEVERROR(
                                   NRF54L_TRACEERR_BADEPGETSTATUS), 0);
                          priv->stalled = true;
                        }
                      else
                        {
                          ...
                          priv->ep0data[1] = 0;
                          nrf54l_ep0in_setupresponse(priv, priv->ep0data, 2);
                        }
                    }
                    break;
                  ...
                  case USB_REQ_RECIPIENT_DEVICE:
                    {
                      if (ctrlreq->index == 0)
                        {
                          usbtrace(TRACE_INTDECODE(
                                   NRF54L_TRACEINTID_DEVGETSTATUS), 0);
                        ...
                        {
                          usbtrace(TRACE_DEVERROR(
                                   NRF54L_TRACEERR_BADDEVGETSTATUS), 0);
                          priv->stalled = true;
                        }
                    }
                  ...
                  case USB_REQ_RECIPIENT_INTERFACE:
                    {
                      usbtrace(TRACE_INTDECODE(
                               NRF54L_TRACEINTID_IFGETSTATUS), 0);
                      priv->ep0data[0] = 0;
                      priv->ep0data[1] = 0;
                  ...
                  default:
                    {
                      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADGETSTATUS),
                               0);
                      priv->stalled = true;
                    }
                    break;
      ...
      case USB_REQ_CLEARFEATURE:
        {
          ...
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_CLEARFEATURE), 0);
          if (priv->addressed != 0 && ctrlreq->len == 0)
            {
              ...
              if (recipient == USB_REQ_RECIPIENT_ENDPOINT &&
                  ...
                  (privep = nrf54l_ep_findbyaddr(priv,
                                                ctrlreq->index)) != NULL)
                {
                  nrf54l_ep_clrstall(privep);
                  nrf54l_ep0in_transmitzlp(priv);
                }
              ...
              else
                {
                  ...
                  nrf54l_req_dispatch(priv, &priv->ctrlreq);
                }
            }
          else
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADCLEARFEATURE), 0);
              priv->stalled = true;
            }
        }
        break;
      ...
      case USB_REQ_SETFEATURE:
        {
          ...
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SETFEATURE), 0);
          if (priv->addressed != 0 && ctrlreq->len == 0)
            {
              uint8_t recipient = ctrlreq->type & USB_REQ_RECIPIENT_MASK;
              ...
              if (recipient == USB_REQ_RECIPIENT_ENDPOINT &&
                ...
                {
                  nrf54l_ep0out_testmode(priv, ctrlreq->index);
                }
                ...
                {
                  usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADSETFEATURE), 0);
                  priv->stalled = true;
                }
            }
          else
      ...
      case USB_REQ_SETADDRESS:
        {
          ...
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SETADDRESS),
                    ctrlreq->value);
          if ((ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
              ...
              priv->devstate != DEVSTATE_CONFIGURED)
            {
              ...
              nrf54l_setaddress(priv, (uint16_t)priv->ctrlreq.value[0]);
              nrf54l_ep0in_transmitzlp(priv);
            }
          else
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADSETADDRESS), 0);
              priv->stalled = true;
            }
        }
        break;
      ...
      case USB_REQ_SETDESCRIPTOR:
        ...
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_GETSETDESC), 0);
          if ((ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
               USB_REQ_RECIPIENT_DEVICE)
            {
              nrf54l_req_dispatch(priv, &priv->ctrlreq);
            ...
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADGETSETDESC), 0);
              priv->stalled = true;
            }
        }
        break;
      ...
      case USB_REQ_GETCONFIGURATION:
        ...
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_GETCONFIG), 0);
          if (priv->addressed &&
            ...
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADGETCONFIG), 0);
              priv->stalled = true;
            }
        }
        break;
      ...
      case USB_REQ_SETCONFIGURATION:
        ...
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SETCONFIG), 0);
          if (priv->addressed &&
              (ctrlreq->type & USB_REQ_RECIPIENT_MASK) ==
               USB_REQ_RECIPIENT_DEVICE &&
               ctrlreq->index == 0 &&
               ctrlreq->len == 0)
            {
              ...
              int ret = nrf54l_req_dispatch(priv, &priv->ctrlreq);
            ...
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADSETCONFIG), 0);
              priv->stalled = true;
            }
        }
        break;
      ...
      case USB_REQ_SETINTERFACE:
        ...
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_GETSETIF), 0);
          nrf54l_req_dispatch(priv, &priv->ctrlreq);
        }
        break;
      ...
      case USB_REQ_SYNCHFRAME:
        ...
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SYNCHFRAME), 0);
        }
        break;

      default:
        {
          usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_INVALIDCTRLREQ), 0);
          priv->stalled = true;
        }
        break;
    }
...
static inline void nrf54l_ep0out_setup(struct nrf54l_usbdev_s *priv)
{
  ...
  if (priv->ep0state != EP0STATE_SETUP_READY)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EP0NOSETUP), priv->ep0state);
      return;
    }

  /* Terminate any pending requests */

  nrf54l_req_cancel(&priv->epout[EP0], -EPROTO);
  nrf54l_req_cancel(&priv->epin[EP0],  -EPROTO);
  ...
  if ((ctrlreq.type & USB_REQ_TYPE_MASK) != USB_REQ_TYPE_STANDARD)
  ...
  else
    {
      ...
      nrf54l_ep0out_stdrequest(priv, &ctrlreq);
    }
  ...
  if (priv->stalled)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EP0SETUPSTALLED),
               priv->ep0state);
      nrf54l_ep0_stall(priv);
    }
...
static inline void nrf54l_epout(struct nrf54l_usbdev_s *priv, uint8_t epno)
{
  struct nrf54l_ep_s *privep;
      ...
      if (priv->ep0state == EP0STATE_DATA_OUT)
        {
          ...
          nrf54l_epout_complete(priv, privep);
   ...
   */
    ...
    {
      nrf54l_epout_complete(priv, &priv->epout[epno]);
    }
}

/****************************************************************************
 * Name: nrf54l_epout_interrupt
 *
 * Description:
...
static inline void nrf54l_epout_interrupt(struct nrf54l_usbdev_s *priv)
{
  ...
  regval  = nrf54l_getreg(NRF54L_USBD_DAINT);
  regval &= nrf54l_getreg(NRF54L_USBD_DAINTMSK);
  ...
  if (daint == 0)
    {
      ...
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EPOUTUNEXPECTED),
               (uint16_t)regval);
      ...
      while (daint)
        {
          if ((daint & 1) != 0)
            {
              regval = nrf54l_getreg(NRF54L_USBD_DOEPINT(epno));
              uerr("DOEPINT(%d) = %08" PRIx32 "\n", epno, regval);
              nrf54l_putreg(0xff, NRF54L_USBD_DOEPINT(epno));
            }
      ...
      if ((daint & 1) != 0)
        {
          ...
          doepint  = nrf54l_getreg(NRF54L_USBD_DOEPINT(epno));
          doepint &= nrf54l_getreg(NRF54L_USBD_DOEPMSK);

          /* Transfer completed interrupt.  This interrupt is triggered when
           * nrf54l_rxinterrupt() removes the last packet data from the
          ...
          if ((doepint & OTG_DOEPINT_XFRC) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPOUT_XFRC),
                       (uint16_t)doepint);

              /* Clear the bit in DOEPINTn for this interrupt */

              nrf54l_putreg(OTG_DOEPINT_XFRC, NRF54L_USBD_DOEPINT(epno));

              /* Handle the RX transfer data ready event */

              nrf54l_epout(priv, epno);
            }
          ...
          if ((doepint & OTG_DOEPINT_EPDISD) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPOUT_EPDISD),
                       (uint16_t)doepint);

              /* Clear the bit in DOEPINTn for this interrupt */

              nrf54l_putreg(OTG_DOEPINT_EPDISD, NRF54L_USBD_DOEPINT(epno));
            }
#endif
          ...
          if ((doepint & OTG_DOEPINT_SETUP) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPOUT_SETUP),
                        priv->ep0state);
              ...
              nrf54l_putreg(OTG_DOEPINT_SETUP,
                           NRF54L_USBD_DOEPINT(epno));
            }
        }
...
static inline void nrf54l_epin_runtestmode(struct nrf54l_usbdev_s *priv)
{
  uint32_t regval = nrf54l_getreg(NRF54L_USBD_DCTL);
...
static inline void nrf54l_epin(struct nrf54l_usbdev_s *priv, uint8_t epno)
{
  struct nrf54l_ep_s *privep = &priv->epin[epno];
      ...
      if (priv->ep0state == EP0STATE_DATA_IN)
        {
          ...
          nrf54l_epin_request(priv, privep);
...
static inline void nrf54l_epin_interrupt(struct nrf54l_usbdev_s *priv)
{
  ...
  daint  = nrf54l_getreg(NRF54L_USBD_DAINT);
  daint &= nrf54l_getreg(NRF54L_USBD_DAINTMSK);
  ...
  if (daint == 0)
    {
      ...
      daint  = nrf54l_getreg(NRF54L_USBD_DAINT);
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_EPINUNEXPECTED),
               (uint16_t)daint);
          ...
          if ((daint & 1) != 0)
            {
              uerr("DIEPINT(%d) = %08" PRIx32 "\n",
                     epno, nrf54l_getreg(NRF54L_USBD_DIEPINT(epno)));
              nrf54l_putreg(0xff, NRF54L_USBD_DIEPINT(epno));
            }
      ...
      if ((daint & 1) != 0)
        {
          ...
          mask = nrf54l_getreg(NRF54L_USBD_DIEPMSK);
          ...
          empty = nrf54l_getreg(NRF54L_USBD_DIEPEMPMSK);
          ...
          diepint = nrf54l_getreg(NRF54L_USBD_DIEPINT(epno)) & mask;
          ...
          if ((diepint & OTG_DIEPINT_XFRC) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_XFRC),
                       (uint16_t)diepint);
              ...
              nrf54l_putreg(empty, NRF54L_USBD_DIEPEMPMSK);
              nrf54l_putreg(OTG_DIEPINT_XFRC, NRF54L_USBD_DIEPINT(epno));

              /* IN transfer complete */

              nrf54l_epin(priv, epno);
            }
          ...
          if ((diepint & OTG_DIEPINT_TOC) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_TOC),
                      (uint16_t)diepint);
              nrf54l_putreg(OTG_DIEPINT_TOC, NRF54L_USBD_DIEPINT(epno));
            }
          ...
          if ((diepint & OTG_DIEPINT_ITTXFE) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_ITTXFE),
                      (uint16_t)diepint);
              nrf54l_epin_request(priv, &priv->epin[epno]);
              nrf54l_putreg(OTG_DIEPINT_ITTXFE, NRF54L_USBD_DIEPINT(epno));
            }
          ...
          if ((diepint & OTG_DIEPINT_INEPNE) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_INEPNE),
                      (uint16_t)diepint);
              nrf54l_putreg(OTG_DIEPINT_INEPNE, NRF54L_USBD_DIEPINT(epno));
            }
#endif
          ...
          if ((diepint & OTG_DIEPINT_EPDISD) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_EPDISD),
                      (uint16_t)diepint);
              nrf54l_putreg(OTG_DIEPINT_EPDISD, NRF54L_USBD_DIEPINT(epno));
            }
#endif
          ...
          if ((diepint & OTG_DIEPINT_TXFE) != 0)
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN_TXFE),
                      (uint16_t)diepint);
              ...
              if ((diepint & OTG_DIEPINT_XFRC) == 0)
                {
                  ...
                  nrf54l_epin_txfifoempty(priv, epno);
                }

              /* Clear the pending TxFIFO empty interrupt */

              nrf54l_putreg(OTG_DIEPINT_TXFE, NRF54L_USBD_DIEPINT(epno));
            }
        }
...
static inline void nrf54l_rxinterrupt(struct nrf54l_usbdev_s *priv)
{
  ...
  regval = nrf54l_getreg(NRF54L_USBD_GRXSTSP);
      ...
      switch (regval & OTG_GRXSTSD_PKTSTS_MASK)
        {
          ...
          case OTG_GRXSTSD_PKTSTS_OUTNAK:
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_OUTNAK), 0);
            }
            break;
          ...
          case OTG_GRXSTSD_PKTSTS_OUTRECVD:
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_OUTRECVD), epphy);
              bcnt = (regval & OTG_GRXSTSD_BCNT_MASK) >>
                      OTG_GRXSTSD_BCNT_SHIFT;
              if (bcnt > 0)
                {
                  nrf54l_epout_receive(privep, bcnt);
                }
            }
            break;
          ...
          case OTG_GRXSTSD_PKTSTS_OUTDONE:
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_OUTDONE), epphy);
            }
            break;
          ...
          case OTG_GRXSTSD_PKTSTS_SETUPDONE:
            {
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SETUPDONE), epphy);
          ...
          case OTG_GRXSTSD_PKTSTS_SETUPRECVD:
            {
              ...
              usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SETUPRECVD), epphy);
              ...
              nrf54l_rxfifo_read(&priv->epout[EP0],
          ...
          default:
            {
              usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_INVALIDPARMS),
...
static inline void nrf54l_enuminterrupt(struct nrf54l_usbdev_s *priv)
{
  ...
  regval = nrf54l_getreg(NRF54L_USBD_DSTS) & OTG_DSTS_ENUMSPD_MASK;
  priv->usbdev.speed = regval == OTG_DSTS_ENUMSPD_HS ? USB_SPEED_HIGH :
                        USB_SPEED_FULL;

  /* Activate EP0 */

  nrf54l_ep0in_activate();

  /* Set USB turn-around time for the 16-bit UTMI+ PHY interface. */

  regval  = nrf54l_getreg(NRF54L_USBD_GUSBCFG);
  regval &= ~OTG_GUSBCFG_TRDT_MASK;
  regval |= OTG_GUSBCFG_TRDT(5);
  nrf54l_putreg(regval, NRF54L_USBD_GUSBCFG);
}

/****************************************************************************
 * Name: nrf54l_isocininterrupt
 *
 * Description:
  ...
  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      ...
      regaddr = NRF54L_USBD_DIEPCTL(privep->epphy);
      doepctl = nrf54l_getreg(regaddr);
      dsts    = nrf54l_getreg(NRF54L_USBD_DSTS);
      ...
      nrf54l_req_complete(privep, -EIO);
      nrf54l_epin_disable(privep);
      break;
    }
}
#endif
...
static int nrf54l_usbinterrupt(int irq, void *context, void *arg)
{
  /* At present, there is only a single OTG  device support. Hence it is
   * pre-allocated as g_usbdev.  However, in most code, the private data
   * structure will be referenced using the 'priv' pointer (rather than the
   * global data) in order to simplify any future support for multiple
   * devices.
   */

  struct nrf54l_usbdev_s *priv = &g_usbdev;
  uint32_t regval;
  uint32_t reserved;

  usbtrace(TRACE_INTENTRY(NRF54L_TRACEINTID_USB), 0);

  if (!nrf54l_ready(priv))
    {
      return OK;
    }
  ...
  DEBUGASSERT((nrf54l_getreg(NRF54L_USBD_GINTSTS) & OTG_GINTSTS_CMOD) ==
               OTG_GINTSTS_DEVMODE);
  ...
  for (; ; )
    {
      ...
      usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_INTPENDING),
              (uint16_t)regval);
      ...
      if ((regval & OTG_GINT_OEP) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPOUT),
                  (uint16_t)regval);
          nrf54l_epout_interrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_IEP) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_EPIN),
                  (uint16_t)regval);
          nrf54l_epin_interrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_MMIS) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_MISMATCH),
                  (uint16_t)regval);
        }
#endif
      ...
      if ((regval & OTG_GINT_WKUP) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_WAKEUP),
                  (uint16_t)regval);
          nrf54l_resumeinterrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_USBSUSP) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SUSPEND),
                  (uint16_t)regval);
          nrf54l_suspendinterrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_SOF) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_SOF),
                  (uint16_t)regval);
          usbdev_sof_irq(&priv->usbdev, nrf54l_getframe(&priv->usbdev));
        }
#endif
      ...
      if ((regval & OTG_GINT_RXFLVL) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_RXFIFO),
                  (uint16_t)regval);
          nrf54l_rxinterrupt(priv);
        }
      ...
      if ((regval & (OTG_GINT_USBRST | OTG_GINT_RSTDET)) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_DEVRESET),
                  (uint16_t)regval);

          /* Perform the device reset */

          nrf54l_usbreset(priv);
          usbtrace(TRACE_INTEXIT(NRF54L_TRACEINTID_USB), 0);
          return OK;
        }
      ...
      if ((regval & OTG_GINT_ENUMDNE) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_ENUMDNE),
                  (uint16_t)regval);
          nrf54l_enuminterrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_IISOIXFR) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_IISOIXFR),
                  (uint16_t)regval);
          nrf54l_isocininterrupt(priv);
        }
      ...
      if ((regval & OTG_GINT_IISOOXFR) != 0)
        {
          usbtrace(TRACE_INTDECODE(NRF54L_TRACEINTID_IISOOXFR),
                  (uint16_t)regval);
          nrf54l_isocoutinterrupt(priv);
        }
#endif
    }
...
static void nrf54l_enablegonak(struct nrf54l_ep_s *privep)
{
...
#if 0
  nrf54l_putreg(OTG_GINT_GONAKEFF, NRF54L_USBD_GINTSTS);
#endif
  ...
  while ((nrf54l_getreg(NRF54L_USBD_GINTSTS) & OTG_GINT_GONAKEFF) == 0);
  nrf54l_putreg(OTG_GINT_GONAKEFF, NRF54L_USBD_GINTSTS);
  ...
  while ((nrf54l_getreg(NRF54L_USBD_DCTL) & OTG_DCTL_GONSTS) == 0);
#endif
}

/****************************************************************************
 * Name: nrf54l_disablegonak
 *
 * Description:
...
{
  int mpsiz;
  uint32_t mpsmask = OTG_DOEPCTL_MPSIZ_MASK;
  uint32_t regaddr;
  uint32_t regval;

  usbtrace(TRACE_EPCONFIGURE, privep->epphy);

  /* EP0 uses an encoded packet size; other endpoints use a byte count. */

  if (privep->epphy == EP0)
    {
      mpsiz = nrf54l_ep0_mpsiz(maxpacket);
      if (mpsiz < 0 || eptype != USB_EP_ATTR_XFER_CONTROL)
        {
          return -EINVAL;
        }

      mpsmask = OTG_DOEPCTL0_MPSIZ_MASK;
    }
  else
    {
  ...
  /* EP0 is always active.  Other active endpoints retain their
   * configuration.
   */

  regaddr = NRF54L_USBD_DOEPCTL(privep->epphy);
  regval  = nrf54l_getreg(regaddr);
  if (privep->epphy == EP0 || (regval & OTG_DOEPCTL_USBAEP) == 0)
    {
      ...
      regval &= ~(mpsmask | OTG_DOEPCTL_EPTYP_MASK);
      regval |= mpsiz;
      regval |= (eptype << OTG_DOEPCTL_EPTYP_SHIFT);
      regval |= OTG_DOEPCTL_USBAEP;
      if (privep->epphy != EP0)
        {
          regval |= OTG_DOEPCTL_SD0PID;
        }
...
{
  int mpsiz;
  uint32_t mpsmask = OTG_DIEPCTL_MPSIZ_MASK;
  uint32_t regaddr;
  uint32_t regval;
  ...
  if (privep->epphy == EP0)
    {
      ...
      mpsmask = OTG_DIEPCTL0_MPSIZ_MASK;
    }
  else
    {
  ...
  regaddr = NRF54L_USBD_DIEPCTL(privep->epphy);
  regval  = nrf54l_getreg(regaddr);
  if (privep->epphy == EP0 || (regval & OTG_DIEPCTL_USBAEP) == 0)
    {
      ...
      regval &= ~(mpsmask | OTG_DIEPCTL_EPTYP_MASK |
...
static int nrf54l_ep_configure(struct usbdev_ep_s *ep,
                              ...
                              bool last)
{
  struct nrf54l_ep_s *privep = (struct nrf54l_ep_s *)ep;
  uint16_t maxpacket;
  uint8_t  eptype;
  irqstate_t flags;
  int ret;
  ...
  if (maxpacket == 0 || maxpacket > 1024 ||
      (privep->isin && maxpacket > NRF54L_TXFIFO_WORDS * 4))
    {
      return -EINVAL;
    }

  flags = enter_critical_section();
  if (!nrf54l_ready(privep->dev))
    {
  ...
  if (privep->isin)
    {
      ret = nrf54l_epin_configure(privep, eptype, maxpacket);
    }
  else
    {
      ret = nrf54l_epout_configure(privep, eptype, maxpacket);
    }
...
static void nrf54l_ep0_configure(struct nrf54l_usbdev_s *priv)
{
  ...
  nrf54l_epin_configure(&priv->epin[EP0], USB_EP_ATTR_XFER_CONTROL,
                       CONFIG_USBDEV_EP0_MAXSIZE);
  nrf54l_epout_configure(&priv->epout[EP0], USB_EP_ATTR_XFER_CONTROL,
                        CONFIG_USBDEV_EP0_MAXSIZE);
}

/****************************************************************************
 * Name: nrf54l_epout_disable
 *
 * Description:
...
#if 0 /* Doesn't happen */
  regaddr = NRF54L_USBD_DOEPINT(privep->epphy);
  while ((nrf54l_getreg(regaddr) & OTG_DOEPINT_EPDISD) == 0);
#else
  /* REVISIT: */
...
static void nrf54l_epin_disable(struct nrf54l_ep_s *privep)
{
  ...
  nrf54l_putreg(OTG_DIEPINT_INEPNE, NRF54L_USBD_DIEPINT(privep->epphy));
  ...
  regaddr = NRF54L_USBD_DIEPINT(privep->epphy);
  while ((nrf54l_getreg(regaddr) & OTG_DIEPINT_INEPNE) == 0);

  /* Clear the INEPNE interrupt indication */

  nrf54l_putreg(OTG_DIEPINT_INEPNE, regaddr);
#endif
  ...
  regaddr = NRF54L_USBD_DIEPINT(privep->epphy);
  while ((nrf54l_getreg(regaddr) & OTG_DIEPINT_EPDISD) == 0);
...
static int nrf54l_ep_disable(struct usbdev_ep_s *ep)
{
  ...
  if (!ep)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_INVALIDPARMS), 0);
      return -EINVAL;
    }
#endif
...
static struct usbdev_req_s *nrf54l_ep_allocreq(struct usbdev_ep_s *ep)
{
  ...
  usbtrace(TRACE_EPALLOCREQ, ((struct nrf54l_ep_s *)ep)->epphy);

  privreq = kmm_malloc(sizeof(struct nrf54l_req_s));
  if (!privreq)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_ALLOCFAIL), 0);
      return NULL;
    }

  memset(privreq, 0, sizeof(struct nrf54l_req_s));
  return &privreq->req;
}

/****************************************************************************
 * Name: nrf54l_ep_freereq
 *
 * Description:
 *   Free an I/O request
 *
...
static void nrf54l_ep_freereq(struct usbdev_ep_s *ep,
                             struct usbdev_req_s *req)
{
  struct nrf54l_req_s *privreq = (struct nrf54l_req_s *)req;
  ...
  usbtrace(TRACE_EPFREEREQ, ((struct nrf54l_ep_s *)ep)->epphy);
  kmm_free(privreq);
}

/****************************************************************************
 * Name: nrf54l_ep_allocbuffer
 *
 * Description:
...
#ifdef CONFIG_USBDEV_DMA
static void *nrf54l_ep_allocbuffer(struct usbdev_ep_s *ep, unsigned bytes)
{
  usbtrace(TRACE_EPALLOCBUFFER, ((struct nrf54l_ep_s *)ep)->epphy);
...
#ifdef CONFIG_USBDEV_DMA
static void nrf54l_ep_freebuffer(struct usbdev_ep_s *ep, void *buf)
{
  usbtrace(TRACE_EPALLOCBUFFER, ((struct nrf54l_ep_s *)ep)->epphy);
                           ...
                           struct usbdev_req_s *req)
{
  ...
  if (!priv->driver)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_NOTCONFIGURED),
               priv->usbdev.speed);
      return -ESHUTDOWN;
    }
#endif
  ...
  if (!priv->driver || !nrf54l_ready(priv))
    {
      ret = -ESHUTDOWN;
    }
  ...
  else
    {
      ...
      if (nrf54l_req_addlast(privep, privreq) && !privep->active)
        {
...
{
#if 1
  /* Disable OUT traffic before stalling the endpoint. */
...
static int nrf54l_ep_setstall(struct nrf54l_ep_s *privep)
{
  ...
  if (privep->isin == 1)
    {
      return nrf54l_epin_setstall(privep);
    }
  else
    {
      return nrf54l_epout_setstall(privep);
    }
}

/****************************************************************************
 * Name: nrf54l_ep_clrstall
 *
 * Description:
...
static int nrf54l_ep_stall(struct usbdev_ep_s *ep, bool resume)
{
  ...
  if (resume)
    {
      ret = nrf54l_ep_clrstall(privep);
    }
  else
    {
      ret = nrf54l_ep_setstall(privep);
    }
...
static void nrf54l_ep0_stall(struct nrf54l_usbdev_s *priv)
{
  nrf54l_epin_setstall(&priv->epin[EP0]);
  nrf54l_epout_setstall(&priv->epout[EP0]);
  priv->stalled = true;
  nrf54l_ep0out_ctrlsetup(priv);
}
...
static struct usbdev_ep_s *nrf54l_ep_alloc(struct usbdev_s *dev,
                                          ...
                                          uint8_t eptype)
{
  struct nrf54l_usbdev_s *priv = (struct nrf54l_usbdev_s *)dev;
  uint16_t epavail;
  irqstate_t flags;
  int epphy;
  int epno = 0;
  ...
  if (epphy > 0)
    {
      ...
      if (epphy >= NRF54L_NENDPOINTS)
        {
          usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BADEPNO), (uint16_t)epphy);
          leave_critical_section(flags);
          return NULL;
        }
  ...
  if (epavail)
    {
      ...
      for (epno = 1; epno < NRF54L_NENDPOINTS; epno++)
        {
          uint16_t bit = 1 << epno;
  ...
  usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_NOEP), (uint16_t)eplog);
  leave_critical_section(flags);
  return NULL;
}
...
static int nrf54l_getframe(struct usbdev_s *dev)
{
  ...
  regval = nrf54l_getreg(NRF54L_USBD_DSTS);
  leave_critical_section(flags);
...
static int nrf54l_selfpowered(struct usbdev_s *dev, bool selfpowered)
{
  struct nrf54l_usbdev_s *priv = (struct nrf54l_usbdev_s *)dev;
...
static int nrf54l_pullup(struct usbdev_s *dev, bool enable)
{
  ...
  flags = enter_critical_section();
  priv->connected = enable;
  if (!enable && priv->active)
    {
      nrf54l_usbhs_pullup(false);
    }

  ret = work_queue(LPWORK, &priv->vbuswork, nrf54l_vbus_worker, priv, 0);
  leave_critical_section(flags);
  return ret == -EBUSY ? OK : ret;
}

/****************************************************************************
 * Name: nrf54l_setaddress
 *
 * Description:
...
static void nrf54l_setaddress(struct nrf54l_usbdev_s *priv, uint16_t address)
{
  uint32_t regval;

  /* Set the device address in the DCFG register */

  regval = nrf54l_getreg(NRF54L_USBD_DCFG);
  regval &= ~OTG_DCFG_DAD_MASK;
  regval |= ((uint32_t)address << OTG_DCFG_DAD_SHIFT);
  nrf54l_putreg(regval, NRF54L_USBD_DCFG);
...
static int nrf54l_txfifo_flush(uint32_t txfnum)
{
  ...
  nrf54l_putreg(regval, NRF54L_USBD_GRSTCTL);

  /* Wait for the FLUSH to complete */

  for (timeout = 0; timeout < NRF54L_FLUSH_DELAY; timeout++)
    {
      regval = nrf54l_getreg(NRF54L_USBD_GRSTCTL);
...
static int nrf54l_rxfifo_flush(void)
{
  ...
  nrf54l_putreg(OTG_GRSTCTL_RXFFLSH, NRF54L_USBD_GRSTCTL);
...
static void nrf54l_swinitialize(struct nrf54l_usbdev_s *priv)
{
  ...
  memset(priv, 0, sizeof(struct nrf54l_usbdev_s));
  ...
  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      ...
      privep->epphy    = i;
      privep->ep.eplog = NRF54L_EPPHYIN2LOG(i);
  ...
  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      ...
      privep->epphy    = i;
      privep->ep.eplog = NRF54L_EPPHYOUT2LOG(i);
...
static int nrf54l_hwinitialize(struct nrf54l_usbdev_s *priv)
{
  ...
  for (timeout = 0; timeout < NRF54L_READY_DELAY; timeout++)
    {
      up_udelay(3);
      regval = nrf54l_getreg(NRF54L_USBD_GRSTCTL);
  ...
  for (timeout = 0; timeout < NRF54L_READY_DELAY; timeout++)
    {
      ...
      if ((regval & OTG_GRSTCTL_CSRST) == 0 ||
          (regval & OTG_GRSTCTL_CSRSTDONE) != 0)
        {
          break;
        }
    }
  ...
  /* CSFTRSTDONE is write-one-to-clear on the LM20 core. */

  nrf54l_putreg(regval & ~OTG_GRSTCTL_CSRST, NRF54L_USBD_GRSTCTL);
  up_udelay(3);

  /* Force device mode with the LM20 16-bit UTMI+ PHY. */

  regval = OTG_GUSBCFG_FDMOD | OTG_GUSBCFG_PHYIF |
           OTG_GUSBCFG_TRDT(5);
  nrf54l_putreg(regval, NRF54L_USBD_GUSBCFG);
  up_mdelay(50);

  if (priv->vbus_changed || !nrf54l_usbhs_vbus())
    {
      return -ENODEV;
    }

  /* The FIFO depth is reported in 32-bit words by the DWC2 core. */

  regval = nrf54l_getreg(NRF54L_USBD_GHWCFG3) >>
           OTG_GHWCFG3_DFIFODEPTH_SHIFT;
  if (regval < NRF54L_RXFIFO_WORDS + NRF54L_EP0_TXFIFO_WORDS +
               (NRF54L_NENDPOINTS - 1) * NRF54L_TXFIFO_WORDS)
    {
      return -ENOSPC;
    }
  ...
  nrf54l_putreg(0, NRF54L_USBD_PCGCCTL);
  ...
  nrf54l_putreg(NRF54L_RXFIFO_WORDS, NRF54L_USBD_GRXFSIZ);

  address = NRF54L_RXFIFO_WORDS;
  regval  = (address << OTG_DIEPTXF0_TX0FD_SHIFT) |
            (NRF54L_EP0_TXFIFO_WORDS << OTG_DIEPTXF0_TX0FSA_SHIFT);
  nrf54l_putreg(regval, NRF54L_USBD_DIEPTXF0);
  address += NRF54L_EP0_TXFIFO_WORDS;
  for (i = 1; i < NRF54L_NENDPOINTS; i++)
    {
      regval = (address << OTG_DIEPTXF_INEPTXSA_SHIFT) |
               (NRF54L_TXFIFO_WORDS << OTG_DIEPTXF_INEPTXFD_SHIFT);
      nrf54l_putreg(regval, NRF54L_USBD_DIEPTXF(i));
      address += NRF54L_TXFIFO_WORDS;
    }

  /* Flush the FIFOs */

  nrf54l_txfifo_flush(OTG_GRSTCTL_TXFNUM_DALL);
  nrf54l_rxfifo_flush();

  /* Clear all pending Device Interrupts */

  nrf54l_putreg(0, NRF54L_USBD_DIEPMSK);
  nrf54l_putreg(0, NRF54L_USBD_DOEPMSK);
  nrf54l_putreg(0, NRF54L_USBD_DIEPEMPMSK);
  nrf54l_putreg(0xffffffff, NRF54L_USBD_DAINT);
  nrf54l_putreg(0, NRF54L_USBD_DAINTMSK);

  /* Configure all IN endpoints */

  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      regval = nrf54l_getreg(NRF54L_USBD_DIEPCTL(i));
      ...
      nrf54l_putreg(regval, NRF54L_USBD_DIEPCTL(i));
      nrf54l_putreg(0, NRF54L_USBD_DIEPTSIZ(i));
      nrf54l_putreg(0xff, NRF54L_USBD_DIEPINT(i));
    }
  ...
  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      regval = nrf54l_getreg(NRF54L_USBD_DOEPCTL(i));
      ...
      nrf54l_putreg(regval, NRF54L_USBD_DOEPCTL(i));
      nrf54l_putreg(0, NRF54L_USBD_DOEPTSIZ(i));
      nrf54l_putreg(0xff, NRF54L_USBD_DOEPINT(i));
    }

  /* Disable all interrupts. */

  nrf54l_putreg(0, NRF54L_USBD_GINTMSK);

  /* Clear any pending USB_OTG Interrupts */

  nrf54l_putreg(0xffffffff, NRF54L_USBD_GOTGINT);

  /* Clear any pending interrupts */

  regval = nrf54l_getreg(NRF54L_USBD_GINTSTS);
  regval &=  OTG_GINT_RESERVED;
  nrf54l_putreg(regval | OTG_GINT_RC_W1, NRF54L_USBD_GINTSTS);
  ...
  nrf54l_putreg(regval, NRF54L_USBD_GINTMSK);
  ...
  nrf54l_putreg(OTG_GAHBCFG_GINTMSK | OTG_GAHBCFG_TXFELVL,
               NRF54L_USBD_GAHBCFG);
  return OK;
}

/****************************************************************************
 * Name: nrf54l_disconnect
 *
 * Description:
 *   Cancel requests without touching core registers after VBUS removal.
 *   The caller holds g_usbdev_lock and prevents new controller starts.
 *
 ****************************************************************************/

static void nrf54l_disconnect(struct nrf54l_usbdev_s *priv)
{
  irqstate_t flags;
  int i;

  flags = enter_critical_section();
  up_disable_irq(NRF54L_IRQ_USBHS);
  priv->active = false;
  priv->usbdev.speed = USB_SPEED_UNKNOWN;
  priv->configured = false;
  priv->addressed = false;
  ...
  for (i = 0; i < NRF54L_NENDPOINTS; i++)
    {
      nrf54l_req_cancel(&priv->epin[i], -ESHUTDOWN);
      nrf54l_req_cancel(&priv->epout[i], -ESHUTDOWN);
      priv->epin[i].active = false;
      priv->epout[i].active = false;
      priv->epin[i].stalled = false;
      priv->epout[i].stalled = false;
    }
...
/****************************************************************************
 * Name: nrf54l_vbus_worker
 *
 * Description:
 *   Perform PHY and controller startup delays outside interrupt context.
 *
 ****************************************************************************/

static void nrf54l_vbus_worker(void *arg)
{
  struct nrf54l_usbdev_s *priv = arg;
  irqstate_t flags;
  int ret;

  ret = nxmutex_lock(&g_usbdev_lock);
  if (ret < 0)
    {
      return;
    }
  ...
  if (priv->active && (priv->vbus_changed || !priv->connected ||
                       !nrf54l_usbhs_vbus()))
    {
      nrf54l_disconnect(priv);
    }

  if (!priv->driver || !priv->connected || !nrf54l_usbhs_vbus())
    {
      goto out;
    }
  ...
  if (!priv->active)
    {
      priv->vbus_changed = false;
      ret = nrf54l_usbhs_enable();
      if (ret < 0)
        {
          goto out;
        }

      ret = nrf54l_hwinitialize(priv);
      if (ret < 0)
        {
          nrf54l_usbhs_disable();
          uerr("ERROR: USB core initialization failed: %d\n", ret);
          goto out;
        }

      flags = enter_critical_section();
      if (priv->vbus_changed || !nrf54l_usbhs_vbus() || !priv->connected)
        {
          leave_critical_section(flags);
          nrf54l_usbhs_disable();
          goto out;
      ...
      priv->active = true;
      modifyreg32(NRF54L_USBD_DCTL, OTG_DCTL_SDIS, 0);
      up_enable_irq(NRF54L_IRQ_USBHS);
      leave_critical_section(flags);
    }

  if (priv->connected)
    {
      nrf54l_usbhs_pullup(true);
    }

out:
  nxmutex_unlock(&g_usbdev_lock);
}

/****************************************************************************
 * Name: nrf54l_vbus_interrupt
 *
 * Description:
...
static int nrf54l_vbus_interrupt(int irq, void *context, void *arg)
{
  ...
  priv->vbus_changed = true;
  up_disable_irq(NRF54L_IRQ_USBHS);
  work_queue(LPWORK, &priv->vbuswork, nrf54l_vbus_worker, priv, 0);
  return OK;
}
...
void arm_usbinitialize(void)
{
  ...
  nrf54l_swinitialize(priv);

  /* Attach the OTG interrupt handler */

  ret = irq_attach(NRF54L_IRQ_USBHS, nrf54l_usbinterrupt, NULL);
  if (ret < 0)
    {
  ...
  /* Core register access waits until VBUS and the PHY clock are ready. */

  priv->initialized = true;
  ret = nrf54l_usbhs_initialize(nrf54l_vbus_interrupt, priv);
  if (ret < 0)
    {
      priv->initialized = false;
      irq_detach(NRF54L_IRQ_USBHS);
      goto errout;
    }
...
errout:
  uerr("ERROR: USB initialization failed: %d\n", ret);
}
...
void arm_usbuninitialize(void)
{
  ...
  if (priv->driver)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_DRIVERREGISTERED), 0);
      usbdev_unregister(priv->driver);
    }

  up_disable_irq(NRF54L_IRQ_VREGUSB);
  up_disable_irq(NRF54L_IRQ_USBHS);
  work_cancel_sync(LPWORK, &priv->vbuswork);
  nxmutex_lock(&g_usbdev_lock);
  nrf54l_disconnect(priv);
  nrf54l_usbhs_uninitialize();
  irq_detach(NRF54L_IRQ_USBHS);
  priv->initialized = false;
  nxmutex_unlock(&g_usbdev_lock);
}
...
int usbdev_register(struct usbdevclass_driver_s *driver)
{
  ...
  if (!driver || !driver->ops || !driver->ops->bind ||
      !driver->ops->unbind || !driver->ops->disconnect ||
      !driver->ops->setup)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_INVALIDPARMS), 0);
      return -EINVAL;
  ...
  if (priv->driver)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_DRIVER), 0);
      nxmutex_unlock(&g_usbdev_lock);
      return -EBUSY;
    }
  ...
  if (ret)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_BINDFAILED), (uint16_t)-ret);
      priv->driver = NULL;
      priv->connected = false;
    }
  else
    {
      ret = nrf54l_pullup(&priv->usbdev, true);
      if (ret < 0)
        {
          priv->connected = false;
...
int usbdev_unregister(struct usbdevclass_driver_s *driver)
{
  ...
  if (driver == NULL || driver != priv->driver)
    {
      usbtrace(TRACE_DEVERROR(NRF54L_TRACEERR_INVALIDPARMS), 0);
      nxmutex_unlock(&g_usbdev_lock);
      return -EINVAL;
