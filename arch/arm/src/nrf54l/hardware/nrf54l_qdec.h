/****************************************************************************
 * arch/arm/src/nrf54l/hardware/nrf54l_qdec.h
 *
...
#ifndef __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_QDEC_H
#define __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_QDEC_H
...
#define NRF54L_QDEC_TASKS_START_OFFSET       0x0000  /* Task starting the quadrature decoder */
#define NRF54L_QDEC_TASKS_STOP_OFFSET        0x0004  /* Task stopping the quadrature decoder */
#define NRF54L_QDEC_TASKS_READCLRACC_OFFSET  0x0008  /* Read and clear ACC and ACCDBL */
#define NRF54L_QDEC_TASKS_RDCLRACC_OFFSET    0x000c  /* Read and clear ACC */
#define NRF54L_QDEC_TASKS_RDCLRDBL_OFFSET    0x0010  /* Read and clear ACCDBL */

#define NRF54L_QDEC_SUBSCRIBE_START_OFFSET      0x0080  /* Subscribe to START */
#define NRF54L_QDEC_SUBSCRIBE_STOP_OFFSET       0x0084  /* Subscribe to STOP */
#define NRF54L_QDEC_SUBSCRIBE_READCLRACC_OFFSET 0x0088  /* Subscribe to READCLRACC */
#define NRF54L_QDEC_SUBSCRIBE_RDCLRACC_OFFSET   0x008c  /* Subscribe to RDCLRACC */
#define NRF54L_QDEC_SUBSCRIBE_RDCLRDBL_OFFSET   0x0090  /* Subscribe to RDCLRDBL */

#define NRF54L_QDEC_EVENTS_SAMPLERDY_OFFSET  0x0100  /* Event being generated for every new sample value */
#define NRF54L_QDEC_EVENTS_REPORTRDY_OFFSET  0x0104  /* Non-null report ready */
#define NRF54L_QDEC_EVENTS_ACCOF_OFFSET      0x0108  /* ACC or ACCDBL register overflow */
#define NRF54L_QDEC_EVENTS_DBLRDY_OFFSET     0x010c  /* Double displacement(s) detected */
#define NRF54L_QDEC_EVENTS_STOPPED_OFFSET    0x0110  /* QDEC has been stopped */

#define NRF54L_QDEC_PUBLISH_SAMPLERDY_OFFSET 0x0180  /* Publish SAMPLERDY */
#define NRF54L_QDEC_PUBLISH_REPORTRDY_OFFSET 0x0184  /* Publish REPORTRDY */
#define NRF54L_QDEC_PUBLISH_ACCOF_OFFSET     0x0188  /* Publish ACCOF */
#define NRF54L_QDEC_PUBLISH_DBLRDY_OFFSET    0x018c  /* Publish DBLRDY */
#define NRF54L_QDEC_PUBLISH_STOPPED_OFFSET   0x0190  /* Publish STOPPED */

#define NRF54L_QDEC_SHORTS_OFFSET            0x0200  /* Shortcut register */
#define NRF54L_QDEC_INTEN_OFFSET             0x0300  /* Enable or disable interrupt */
#define NRF54L_QDEC_INTENSET_OFFSET          0x0304  /* Enable interrupt */
#define NRF54L_QDEC_INTENCLR_OFFSET          0x0308  /* Disable interrupt */
#define NRF54L_QDEC_ENABLE_OFFSET            0x0500  /* Enable the quadrature decoder */
#define NRF54L_QDEC_LEDPOL_OFFSET            0x0504  /* LED output pin polarity */
#define NRF54L_QDEC_SAMPLEPER_OFFSET         0x0508  /* Sample period */
#define NRF54L_QDEC_SAMPLE_OFFSET            0x050c  /* Motion sample value */
#define NRF54L_QDEC_REPORTPER_OFFSET         0x0510  /* Number of samples to be taken before REPORTRDY and DBLRDY events */
#define NRF54L_QDEC_ACC_OFFSET               0x0514  /* Register accumulating the valid transitions */
#define NRF54L_QDEC_ACCREAD_OFFSET           0x0518  /* Snapshot of the ACC register */
#define NRF54L_QDEC_PSEL_LED_OFFSET          0x051c  /* Pin select for LED signal */
#define NRF54L_QDEC_PSEL_A_OFFSET            0x0520  /* Pin select for A signal */
#define NRF54L_QDEC_PSEL_B_OFFSET            0x0524  /* Pin select for B signal */
#define NRF54L_QDEC_DBFEN_OFFSET             0x0528  /* Enable input debounce filters */
#define NRF54L_QDEC_LEDPRE_OFFSET            0x0540  /* Time period the LED is switched ON prior to sampling */
#define NRF54L_QDEC_ACCDBL_OFFSET            0x0544  /* Register accumulating the number of detected double transitions */
#define NRF54L_QDEC_ACCDBLREAD_OFFSET        0x0548  /* Snapshot of the ACCDBL register */

/* Register Bitfield Definitions ********************************************/

/* SUBSCRIBE and PUBLISH Registers */

#define QDEC_SUBSCRIBE_CHIDX_SHIFT          (0)
#define QDEC_SUBSCRIBE_CHIDX_MASK           (0xff << QDEC_SUBSCRIBE_CHIDX_SHIFT)
#define QDEC_SUBSCRIBE_EN                   (1 << 31)
#define QDEC_PUBLISH_CHIDX_SHIFT            (0)
#define QDEC_PUBLISH_CHIDX_MASK             (0xff << QDEC_PUBLISH_CHIDX_SHIFT)
#define QDEC_PUBLISH_EN                     (1 << 31)
...
#define QDEC_PSEL_PORT_SHIFT                (5)       /* Bits 5-7: Port number */
#define QDEC_PSEL_PORT_MASK                 (0x7 << QDEC_PSEL_PORT_SHIFT)
...
#endif /* __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_QDEC_H */
