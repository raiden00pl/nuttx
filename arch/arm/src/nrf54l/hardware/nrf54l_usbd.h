/****************************************************************************
 * arch/arm/src/nrf54l/hardware/nrf54l_usbd.h
 *
...
#ifndef __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_USBD_H
#define __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_USBD_H
...
#define NRF54L_USBD_GOTGCTL_OFFSET      0x0000 /* Control and status register */
#define NRF54L_USBD_GOTGINT_OFFSET      0x0004 /* Interrupt register */
#define NRF54L_USBD_GAHBCFG_OFFSET      0x0008 /* AHB configuration register */
#define NRF54L_USBD_GUSBCFG_OFFSET      0x000c /* USB configuration register */
#define NRF54L_USBD_GRSTCTL_OFFSET      0x0010 /* Reset register */
#define NRF54L_USBD_GINTSTS_OFFSET      0x0014 /* Core interrupt register */
#define NRF54L_USBD_GINTMSK_OFFSET      0x0018 /* Interrupt mask register */
#define NRF54L_USBD_GRXSTSR_OFFSET      0x001c /* Receive status debug read/OTG status read register */
#define NRF54L_USBD_GRXSTSP_OFFSET      0x0020 /* Receive status debug read/OTG status pop register */
#define NRF54L_USBD_GRXFSIZ_OFFSET      0x0024 /* Receive FIFO size register */
#define NRF54L_USBD_HNPTXFSIZ_OFFSET    0x0028 /* Host non-periodic transmit FIFO size register */
#define NRF54L_USBD_DIEPTXF0_OFFSET     0x0028 /* Endpoint 0 Transmit FIFO size */
#define NRF54L_USBD_HNPTXSTS_OFFSET     0x002c /* Non-periodic transmit FIFO/queue status register */
#define NRF54L_USBD_GGPIO_OFFSET        0x0038 /* General purpose input/output register */
#define NRF54L_USBD_GUID_OFFSET         0x003c /* User ID register */
#define NRF54L_USBD_GSNPSID_OFFSET      0x0040 /* Synopsys core revision */
#define NRF54L_USBD_GHWCFG1_OFFSET      0x0044 /* Hardware configuration 1 */
#define NRF54L_USBD_GHWCFG2_OFFSET      0x0048 /* Hardware configuration 2 */
#define NRF54L_USBD_GHWCFG3_OFFSET      0x004c /* Hardware configuration 3 */
#define NRF54L_USBD_GHWCFG4_OFFSET      0x0050 /* Hardware configuration 4 */
#define NRF54L_USBD_HPTXFSIZ_OFFSET     0x0100 /* Host periodic transmit FIFO size register */

#define NRF54L_USBD_DIEPTXF_OFFSET(n)   (0x0104+(((n)-1) << 2)) /* Device IN endpoint n transmit FIFO size */

/* Host-mode control and status registers */

#define NRF54L_USBD_HCFG_OFFSET         0x0400 /* Host configuration register */
#define NRF54L_USBD_HFIR_OFFSET         0x0404 /* Host frame interval register */
#define NRF54L_USBD_HFNUM_OFFSET        0x0408 /* Host frame number/frame time remaining register */
#define NRF54L_USBD_HPTXSTS_OFFSET      0x0410 /* Host periodic transmit FIFO/queue status register */
#define NRF54L_USBD_HAINT_OFFSET        0x0414 /* Host all channels interrupt register */
#define NRF54L_USBD_HAINTMSK_OFFSET     0x0418 /* Host all channels interrupt mask register */
#define NRF54L_USBD_HPRT_OFFSET         0x0440 /* Host port control and status register */

#define NRF54L_USBD_CHAN_OFFSET(n)      (0x500 + ((n) << 5)) /* Host channel n register block */
#define NRF54L_USBD_HCCHAR_CHOFFSET     0x0000               /* Host channel characteristics register */
#define NRF54L_USBD_HCINT_CHOFFSET      0x0008               /* Host channel interrupt register */
#define NRF54L_USBD_HCINTMSK_CHOFFSET   0x000c               /* Host channel interrupt mask register */
#define NRF54L_USBD_HCTSIZ_CHOFFSET     0x0010               /* Host channel transfer size register */

#define NRF54L_USBD_HCCHAR_OFFSET(n)    (0x500 + ((n) << 5)) /* Host channel n characteristics */

#define NRF54L_USBD_HCINT_OFFSET(n)     (0x508 + ((n) << 5)) /* Host channel n interrupt status */

#define NRF54L_USBD_HCINTMSK_OFFSET(n)  (0x50c + ((n) << 5)) /* Host channel n interrupt mask */

#define NRF54L_USBD_HCTSIZ_OFFSET(n)    (0x510 + ((n) << 5)) /* Host channel n transfer size */

/* Device-mode control and status registers */

#define NRF54L_USBD_DCFG_OFFSET         0x0800 /* Device configuration register */
#define NRF54L_USBD_DCTL_OFFSET         0x0804 /* Device control register */
#define NRF54L_USBD_DSTS_OFFSET         0x0808 /* Device status register */
#define NRF54L_USBD_DIEPMSK_OFFSET      0x0810 /* Device IN endpoint common interrupt mask register */
#define NRF54L_USBD_DOEPMSK_OFFSET      0x0814 /* Device OUT endpoint common interrupt mask register */
#define NRF54L_USBD_DAINT_OFFSET        0x0818 /* Device all endpoints interrupt register */
#define NRF54L_USBD_DAINTMSK_OFFSET     0x081c /* All endpoints interrupt mask register */
#define NRF54L_USBD_DVBUSDIS_OFFSET     0x0828 /* Device VBUS discharge time register */
#define NRF54L_USBD_DVBUSPULSE_OFFSET   0x082c /* Device VBUS pulsing time register */
#define NRF54L_USBD_DIEPEMPMSK_OFFSET   0x0834 /* Device IN endpoint FIFO empty interrupt mask register */

#define NRF54L_USBD_DIEP_OFFSET(n)      (0x0900 + ((n) << 5)) /* Device IN endpoint n register block */
#define NRF54L_USBD_DIEPCTL_EPOFFSET    0x0000                /* Device endpoint control register */
#define NRF54L_USBD_DIEPINT_EPOFFSET    0x0008                /* Device endpoint interrupt register */
#define NRF54L_USBD_DIEPTSIZ_EPOFFSET   0x0010                /* Device IN endpoint transfer size register */
#define NRF54L_USBD_DTXFSTS_EPOFFSET    0x0018                /* Device IN endpoint transmit FIFO status register */

#define NRF54L_USBD_DIEPCTL_OFFSET(n)   (0x0900 + ((n) << 5)) /* Device IN endpoint n control */

#define NRF54L_USBD_DIEPINT_OFFSET(n)   (0x0908 + ((n) << 5)) /* Device IN endpoint n interrupt status */

#define NRF54L_USBD_DIEPTSIZ_OFFSET(n)  (0x910 + ((n) << 5))  /* Device IN endpoint n transfer size */

#define NRF54L_USBD_DTXFSTS_OFFSET(n)   (0x0918 + ((n) << 5)) /* Device IN endpoint n transmit FIFO status */

#define NRF54L_USBD_DOEP_OFFSET(n)      (0x0b00 + ((n) << 5)) /* Device OUT endpoint n register block */
#define NRF54L_USBD_DOEPCTL_EPOFFSET    0x0000                /* Device control OUT endpoint 0 control register */
#define NRF54L_USBD_DOEPINT_EPOFFSET    0x0008                /* Device endpoint-x interrupt register */

#define NRF54L_USBD_DOEPCTL_OFFSET(n)   (0x0b00 + ((n) << 5)) /* Device OUT endpoint n control */

#define NRF54L_USBD_DOEPINT_OFFSET(n)   (0x0b08 + ((n) << 5)) /* Device OUT endpoint n interrupt status */

#define NRF54L_USBD_DOEPTSIZ_OFFSET(n)  (0x0b10 + ((n) << 5)) /* Device OUT endpoint n transfer size */

/* Power and clock gating registers */

#define NRF54L_USBD_PCGCCTL_OFFSET      0x0e00 /* Power and clock gating control register */

/* Data FIFO (DFIFO) access registers */

#define NRF54L_USBD_DFIFO_DEP_OFFSET(n) (0x1000 + ((n) << 12)) /* Device endpoint n FIFO access */
#define NRF54L_USBD_DFIFO_HCH_OFFSET(n) (0x1000 + ((n) << 12)) /* Host channel n FIFO access */

/* Register Addresses *******************************************************/

#define NRF54L_USBD_GOTGCTL             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GOTGCTL_OFFSET)
#define NRF54L_USBD_GOTGINT             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GOTGINT_OFFSET)
#define NRF54L_USBD_GAHBCFG             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GAHBCFG_OFFSET)
#define NRF54L_USBD_GUSBCFG             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GUSBCFG_OFFSET)
#define NRF54L_USBD_GRSTCTL             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GRSTCTL_OFFSET)
#define NRF54L_USBD_GINTSTS             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GINTSTS_OFFSET)
#define NRF54L_USBD_GINTMSK             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GINTMSK_OFFSET)
#define NRF54L_USBD_GRXSTSR             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GRXSTSR_OFFSET)
#define NRF54L_USBD_GRXSTSP             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GRXSTSP_OFFSET)
#define NRF54L_USBD_GRXFSIZ             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GRXFSIZ_OFFSET)
#define NRF54L_USBD_HNPTXFSIZ           (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HNPTXFSIZ_OFFSET)
#define NRF54L_USBD_DIEPTXF0            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPTXF0_OFFSET)
#define NRF54L_USBD_HNPTXSTS            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HNPTXSTS_OFFSET)
#define NRF54L_USBD_GGPIO               (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GGPIO_OFFSET)
#define NRF54L_USBD_GUID                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GUID_OFFSET)
#define NRF54L_USBD_GSNPSID             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GSNPSID_OFFSET)
#define NRF54L_USBD_GHWCFG1             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GHWCFG1_OFFSET)
#define NRF54L_USBD_GHWCFG2             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GHWCFG2_OFFSET)
#define NRF54L_USBD_GHWCFG3             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GHWCFG3_OFFSET)
#define NRF54L_USBD_GHWCFG4             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_GHWCFG4_OFFSET)
#define NRF54L_USBD_HPTXFSIZ            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HPTXFSIZ_OFFSET)

#define NRF54L_USBD_DIEPTXF(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPTXF_OFFSET(n))

/* Host-mode control and status registers */

#define NRF54L_USBD_HCFG                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HCFG_OFFSET)
#define NRF54L_USBD_HFIR                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HFIR_OFFSET)
#define NRF54L_USBD_HFNUM               (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HFNUM_OFFSET)
#define NRF54L_USBD_HPTXSTS             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HPTXSTS_OFFSET)
#define NRF54L_USBD_HAINT               (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HAINT_OFFSET)
#define NRF54L_USBD_HAINTMSK            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HAINTMSK_OFFSET)
#define NRF54L_USBD_HPRT                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HPRT_OFFSET)

#define NRF54L_USBD_CHAN(n)             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_CHAN_OFFSET(n))

#define NRF54L_USBD_HCCHAR(n)           (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HCCHAR_OFFSET(n))

#define NRF54L_USBD_HCINT(n)            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HCINT_OFFSET(n))

#define NRF54L_USBD_HCINTMSK(n)         (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HCINTMSK_OFFSET(n))

#define NRF54L_USBD_HCTSIZ(n)           (NRF54L_USBHSCORE_BASE+NRF54L_USBD_HCTSIZ_OFFSET(n))

/* Device-mode control and status registers */

#define NRF54L_USBD_DCFG                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DCFG_OFFSET)
#define NRF54L_USBD_DCTL                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DCTL_OFFSET)
#define NRF54L_USBD_DSTS                (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DSTS_OFFSET)
#define NRF54L_USBD_DIEPMSK             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPMSK_OFFSET)
#define NRF54L_USBD_DOEPMSK             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DOEPMSK_OFFSET)
#define NRF54L_USBD_DAINT               (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DAINT_OFFSET)
#define NRF54L_USBD_DAINTMSK            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DAINTMSK_OFFSET)
#define NRF54L_USBD_DVBUSDIS            (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DVBUSDIS_OFFSET)
#define NRF54L_USBD_DVBUSPULSE          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DVBUSPULSE_OFFSET)
#define NRF54L_USBD_DIEPEMPMSK          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPEMPMSK_OFFSET)

#define NRF54L_USBD_DIEP(n)             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEP_OFFSET(n))

#define NRF54L_USBD_DIEPCTL(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPCTL_OFFSET(n))

#define NRF54L_USBD_DIEPINT(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPINT_OFFSET(n))

#define NRF54L_USBD_DIEPTSIZ(n)         (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DIEPTSIZ_OFFSET(n))

#define NRF54L_USBD_DTXFSTS(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DTXFSTS_OFFSET(n))

#define NRF54L_USBD_DOEP(n)             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DOEP_OFFSET(n))

#define NRF54L_USBD_DOEPCTL(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DOEPCTL_OFFSET(n))

#define NRF54L_USBD_DOEPINT(n)          (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DOEPINT_OFFSET(n))

#define NRF54L_USBD_DOEPTSIZ(n)         (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DOEPTSIZ_OFFSET(n))

/* Power and clock gating registers */

#define NRF54L_USBD_PCGCCTL             (NRF54L_USBHSCORE_BASE+NRF54L_USBD_PCGCCTL_OFFSET)

/* Data FIFO (DFIFO) access registers */

#define NRF54L_USBD_DFIFO_DEP(n)        (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DFIFO_DEP_OFFSET(n))
#define NRF54L_USBD_DFIFO_HCH(n)        (NRF54L_USBHSCORE_BASE+NRF54L_USBD_DFIFO_HCH_OFFSET(n))
...
#define OTG_GUSBCFG_PHYIF             (1 << 3)  /* Bit 3: 16-bit UTMI+ interface */
#define OTG_GUSBCFG_ULPIUTMISEL       (1 << 4)  /* Bit 4: Select ULPI instead of UTMI+ */
...
#define OTG_GRSTCTL_CSRSTDONE         (1 << 29)                         /* Bit 29: Core soft reset done */
...
#define OTG_GRXFSIZ_MASK              (0x0fff)

/* Host non-periodic transmit FIFO size register */

#define OTG_HNPTXFSIZ_NPTXFSA_SHIFT   (0)       /* Bits 0-11: Non-periodic transmit RAM start address */
#define OTG_HNPTXFSIZ_NPTXFSA_MASK    (0x0fff << OTG_HNPTXFSIZ_NPTXFSA_SHIFT)
#define OTG_HNPTXFSIZ_NPTXFD_SHIFT    (16)      /* Bits 16-27: Non-periodic TxFIFO depth */
#define OTG_HNPTXFSIZ_NPTXFD_MASK     (0x0fff << OTG_HNPTXFSIZ_NPTXFD_SHIFT)
...
#define OTG_DIEPTXF0_TX0FD_SHIFT      (0)       /* Bits 0-11: Endpoint 0 transmit RAM start address */
#define OTG_DIEPTXF0_TX0FD_MASK       (0x0fff << OTG_DIEPTXF0_TX0FD_SHIFT)
#define OTG_DIEPTXF0_TX0FSA_SHIFT     (16)      /* Bits 16-27: Endpoint 0 TxFIFO depth */
#define OTG_DIEPTXF0_TX0FSA_MASK      (0x0fff << OTG_DIEPTXF0_TX0FSA_SHIFT)
...
#define OTG_GHWCFG3_DFIFODEPTH_SHIFT  (16)      /* Bits 16-31: FIFO depth in words */
#define OTG_GHWCFG3_DFIFODEPTH_MASK   (0xffff << OTG_GHWCFG3_DFIFODEPTH_SHIFT)
...
#define OTG_DIEPTXF_INEPTXSA_SHIFT    (0)       /* Bits 0-12: IN endpoint FIFOx transmit RAM start address */
#define OTG_DIEPTXF_INEPTXSA_MASK     (0x1fff << OTG_DIEPTXF_INEPTXSA_SHIFT)
#define OTG_DIEPTXF_INEPTXFD_SHIFT    (16)      /* Bits 16-27: IN endpoint TxFIFO depth */
#define OTG_DIEPTXF_INEPTXFD_MASK     (0x0fff << OTG_DIEPTXF_INEPTXFD_SHIFT)
...
#  define OTG_DSTS_ENUMSPD_HS         (0 << OTG_DSTS_ENUMSPD_SHIFT)
#  define OTG_DSTS_ENUMSPD_FSHS       (1 << OTG_DSTS_ENUMSPD_SHIFT)
#  define OTG_DSTS_ENUMSPD_FS         (3 << OTG_DSTS_ENUMSPD_SHIFT)
...
/* Device control IN endpoint 0 maximum packet size */
...
#endif /* __ARCH_ARM_SRC_NRF54L_HARDWARE_NRF54L_USBD_H */
